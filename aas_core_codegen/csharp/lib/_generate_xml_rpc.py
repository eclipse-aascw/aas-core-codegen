...
{I}try
{I}{{
{II}return reader.ReadContentAsDouble();
{I}}}
{I}catch (System.Exception exception)
{IIII}when (exception is System.FormatException
...
{II}// NOTE (mristin):
{II}// A member with a repeated key overwrites the previous value for
{II}// that key, mirroring Nodes.JsonObject's own indexer assignment
{II}// semantics.
{II}result[key] = item;
{I}}}

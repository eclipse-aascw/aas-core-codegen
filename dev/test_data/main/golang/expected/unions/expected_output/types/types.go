...
// Wrap `that` as an instance of [StructuralUnion] based on its run-time type.
//
// This is the method-level counterpart of [StructuralUnionFromUnderlying], needed
...
func (s *StructuralUnion) WithUnderlying(that IClass) *StructuralUnion {
	return StructuralUnionFromUnderlying(that)
}
...
// Wrap `that` as an instance of [MixedUnion] based on its run-time type.
//
// This is the method-level counterpart of [MixedUnionFromUnderlying], needed
// so that a generic function constrained to a self-referential union
// interface can re-wrap a transformed value without knowing the concrete
// union type at compile time.
func (m *MixedUnion) WithUnderlying(that IClass) *MixedUnion {
	return MixedUnionFromUnderlying(that)
}
...
// Wrap `that` as an instance of [ModelTypedUnion] based on its run-time type.
//
// This is the method-level counterpart of [ModelTypedUnionFromUnderlying], needed
// so that a generic function constrained to a self-referential union
// interface can re-wrap a transformed value without knowing the concrete
// union type at compile time.

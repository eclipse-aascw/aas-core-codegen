...
func (es *enhancedSomething[E]) SomeOptionalFloat(
) *float64 {
	return es.instance.SomeOptionalFloat()
}

func (es *enhancedSomething[E]) SetSomeOptionalFloat(
	value *float64,
) {
	es.instance.SetSomeOptionalFloat(value)
}

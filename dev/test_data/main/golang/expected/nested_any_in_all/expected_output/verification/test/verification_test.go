...
func TestLangStringOK(t *testing.T) {
...
func TestLangStringFail(t *testing.T) {
...
func TestLangStringSetOK(t *testing.T) {
	pths := aastesting.FindFilesBySuffixRecursively(
		filepath.Join(
			aastesting.TestDataDir,
			"Json",
...
func TestLangStringSetFail(t *testing.T) {
	pattern := filepath.Join(
		aastesting.TestDataDir,
		"Json",
		"Unexpected",
...
func TestIecContentOK(t *testing.T) {
	pths := aastesting.FindFilesBySuffixRecursively(
		filepath.Join(
			aastesting.TestDataDir,
			"Json",
...
func TestIecContentFail(t *testing.T) {
	pattern := filepath.Join(
		aastesting.TestDataDir,
		"Json",
		"Unexpected",
...
func TestOtherContentOK(t *testing.T) {
	pths := aastesting.FindFilesBySuffixRecursively(
		filepath.Join(
			aastesting.TestDataDir,
			"Json",
...
func TestOtherContentFail(t *testing.T) {
	pattern := filepath.Join(
		aastesting.TestDataDir,
		"Json",
		"Unexpected",
...
func TestSpecificationFail(t *testing.T) {
	pattern := filepath.Join(
		aastesting.TestDataDir,
		"Json",
		"Unexpected",

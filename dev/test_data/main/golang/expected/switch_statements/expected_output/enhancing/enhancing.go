...
func (es *enhancedSomething[E]) Text(
) string {
	return es.instance.Text()
}

func (es *enhancedSomething[E]) SetText(
	value string,
) {
	es.instance.SetText(value)
}

func (es *enhancedSomething[E]) Name(
) string {
	return es.instance.Name()
}

func (es *enhancedSomething[E]) SetName(
	value string,
) {
	es.instance.SetName(value)
}

func (es *enhancedSomething[E]) Number(
) int64 {
	return es.instance.Number()
}

func (es *enhancedSomething[E]) SetNumber(
	value int64,
) {
	es.instance.SetNumber(value)
}

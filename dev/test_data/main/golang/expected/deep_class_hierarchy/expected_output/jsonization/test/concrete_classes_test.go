...
func TestLeafSerializationFailOnOutOfRangeValue(t *testing.T) {
	pth := mustFirstExpectedPath(t, "Leaf")
...
func TestBlossomSerializationFailOnOutOfRangeValue(t *testing.T) {
	pth := mustFirstExpectedPath(t, "Blossom")

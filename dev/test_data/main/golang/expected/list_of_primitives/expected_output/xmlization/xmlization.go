...
func readBooleanAtV(
	...
	return readTextAsBoolean(decoder, current)
}
...
func readDoubleAtV(
	...
	return readTextAsDouble(decoder, current)
}
...
// The `current` token is expected to point to the content of that element, and
// the resulting `next` token points to its end element.
func readBase64EncodedBytesAtV(
	decoder *xml.Decoder,
	current xml.Token,
	local string,
) (value []byte,
	...
	return readTextAsBase64EncodedBytes(decoder, current)
}
...
func readSomethingAsSequence(
	...
	for {
		...
		case "someBools":
			theSomeBools, current, valueErr = readListOf(
				decoder, current, readBooleanAtV,
			)
			foundSomeBools = true
		case "someInts":
			theSomeInts, current, valueErr = readListOf(
				decoder, current, readLongAtV,
			)
			foundSomeInts = true
		case "someFloats":
			theSomeFloats, current, valueErr = readListOf(
				decoder, current, readDoubleAtV,
			)
		...
		case "someBytes":
			theSomeBytes, current, valueErr = readListOf(
				decoder, current, readBase64EncodedBytesAtV,
			)
			foundSomeBytes = true
		default:
	...
	if !foundSomeBools {
		err = missingProperty("someBools")
		return
	}

	if !foundSomeInts {
		err = missingProperty("someInts")
		return
	}
	...
	if !foundSomeStrings {
		err = missingProperty("someStrings")
		return
	}

	if !foundSomeBytes {
		err = missingProperty("someBytes")
		return
	}
...
//
// Do not flush.
func writeBooleanAtV(
	encoder *xml.Encoder,
	value bool,
) error {
	return writeElement(
		encoder, "v", value, writeBooleanAsText,
	)
}
...
func writeLongAtV(
	...
	return writeElement(
		encoder, "v", value, writeLongAsText,
	)
}
...
func writeDoubleAtV(
	...
	return writeElement(
		encoder, "v", value, writeDoubleAsText,
	)
}
...
//
// Do not flush.
func writeBase64EncodedBytesAtV(
	encoder *xml.Encoder,
	value []byte,
) error {
	return writeElement(
		encoder, "v", value, writeBytesAsText,
	)
}
...
//
// Do not flush.
func writeListOfBool(
	encoder *xml.Encoder,
	list []bool,
) error {
	return writeList(
		encoder, list, writeBooleanAtV,
	)
}
...
//
// Do not flush.
func writeListOfLong(
	encoder *xml.Encoder,
	list []int64,
) error {
	return writeList(
		encoder, list, writeLongAtV,
	)
}
...
//
// Do not flush.
func writeListOfDouble(
	encoder *xml.Encoder,
	list []float64,
) error {
	return writeList(
		encoder, list, writeDoubleAtV,
	)
}
...
//
// Do not flush.
func writeListOfBytes(
	encoder *xml.Encoder,
	list [][]byte,
) error {
	return writeList(
		encoder, list, writeBase64EncodedBytesAtV,
	)
}
...
func writeSomethingAsSequence(
	...
	err = finishProperty(
		"SomeBools()",
		writeElement(
			encoder, "someBools", that.SomeBools(), writeListOfBool,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeInts()",
		writeElement(
			encoder, "someInts", that.SomeInts(), writeListOfLong,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeFloats()",
		writeElement(
			encoder, "someFloats", that.SomeFloats(), writeListOfDouble,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeStrings()",
		writeElement(
			encoder, "someStrings", that.SomeStrings(), writeListOfString,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeBytes()",
		writeElement(
			encoder, "someBytes", that.SomeBytes(), writeListOfBytes,
		),
	)
	if err != nil {
		return

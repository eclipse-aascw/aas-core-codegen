...
func readAtV_bytes(
	...
	return xmlcommon.ReadTextAs_bytes(decoder, current)
}
...
func writeAtV_bool(
	...
	return xmlcommon.WriteElement(
		encoder, "v", value, xmlcommon.WriteAsText_bool,
	)
}
...
func writeAtV_long(
	...
	return xmlcommon.WriteElement(
		encoder, "v", value, xmlcommon.WriteAsText_long,
	)
}
...
func writeAtV_string(
	...
	return xmlcommon.WriteElement(
		encoder, "v", value, xmlcommon.WriteAsText_string,
	)
}
...
func writeAtV_bytes(
	...
	return xmlcommon.WriteElement(
		encoder, "v", value, xmlcommon.WriteAsText_bytes,
	)
}
...
//
// Do not flush.
func writeListOf_bool(
	encoder *xml.Encoder,
	list []bool,
) error {
	return writeList(
		encoder, list, writeAtV_bool,
	)
}
...
//
// Do not flush.
func writeListOf_long(
	encoder *xml.Encoder,
	list []int64,
) error {
	return writeList(
		encoder, list, writeAtV_long,
	)
}
...
//
// Do not flush.
func writeListOf_bytes(
	encoder *xml.Encoder,
	list [][]byte,
) error {
	return writeList(
		encoder, list, writeAtV_bytes,
	)
}
...
func writeSomethingAsSequence(
	...
	err = finishProperty(
		...
		xmlcommon.WriteElement(
			encoder, "someBools", that.SomeBools(), writeListOf_bool,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeInts()",
		xmlcommon.WriteElement(
			encoder, "someInts", that.SomeInts(), writeListOf_long,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeStrings()",
		xmlcommon.WriteElement(
			encoder, "someStrings", that.SomeStrings(), writeListOf_string,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"SomeBytes()",
		xmlcommon.WriteElement(
			encoder, "someBytes", that.SomeBytes(), writeListOf_bytes,
		),
	)
	if err != nil {
		return

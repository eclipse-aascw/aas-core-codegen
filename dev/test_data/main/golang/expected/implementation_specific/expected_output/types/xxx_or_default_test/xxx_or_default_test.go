...
func TestBoxColorOrDefaultOnMinimal(t *testing.T) {
	instance := aastesting.MustLoadMinimalBox()

	value := &enumerationLiteral{
		enumerationName: "Color",
		literalName: aasstringification.MustColorToString(
...
func TestBoxColorOrDefaultOnMaximal(t *testing.T) {

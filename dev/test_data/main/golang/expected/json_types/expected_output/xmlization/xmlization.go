...
func writeSomethingAsSequence(
	...
	err = finishProperty(
		...
		xmlcommon.WriteElement(
			encoder, "value", that.Value(), xmlrpc.WriteValueContent,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		...
		writeOptionalJsonValue(
			encoder, "optionalValue", that.OptionalValue(), xmlrpc.WriteValueContent,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"OptionalValues()",
		writeOptionalSlice(
			encoder, "optionalValues", that.OptionalValues(), xmlrpc.WriteArrayContent,
		),
	)
	if err != nil {
		return

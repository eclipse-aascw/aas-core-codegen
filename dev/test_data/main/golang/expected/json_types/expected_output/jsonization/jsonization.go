...
func somethingFromMapWithoutDispatch(
	...
	for k, v := range m {
		switch k {
		case "value":
			theValue, err = jsonValueFromJsonable(v)
			foundValue = true
		...
		case "mappingWithConstrainedKey":
			theMappingWithConstrainedKey, err = jsonObjectFromJsonable(v)
			foundMappingWithConstrainedKey = true

		case "optionalValue":
			theOptionalValue, err = jsonValueFromJsonable(v)

		case "optionalValues":
			theOptionalValues, err = jsonArrayFromJsonable(v)
	...
	result.SetOptionalValue(
		theOptionalValue,
	)
	result.SetOptionalValues(
		theOptionalValues,
	)
...
func somethingToMap(
	...
	result["value"], err = jsonValueToJsonable(that.Value())
	if err != nil {
	...
	result["mappingWithConstrainedKey"], err = jsonValueToJsonable(
		that.MappingWithConstrainedKey(),
	)
	if err != nil {
		mustSerializationError(err).prependName("MappingWithConstrainedKey()")
		return
	}

	if that.OptionalValue() != nil {
		result["optionalValue"], err = jsonValueToJsonable(that.OptionalValue())
		if err != nil {
			mustSerializationError(err).prependName("OptionalValue()")
			return
		}
	}

	if that.OptionalValues() != nil {
		result["optionalValues"], err = jsonValueToJsonable(that.OptionalValues())
		if err != nil {
			mustSerializationError(err).prependName("OptionalValues()")
			return
		}
	}

	if that.OptionalMapping() != nil {
		result["optionalMapping"], err = jsonValueToJsonable(that.OptionalMapping())
		if err != nil {
			mustSerializationError(err).prependName("OptionalMapping()")
			return
		}
	}

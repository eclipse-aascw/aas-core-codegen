...
func readSomethingAsSequence(
	...
	for {
		...
		case "interface":
			...
			theInterface, current, valueErr = xmlcommon.ReadText(
				decoder, current,
			)
			foundInterface = true
		case "type":
		...
		case "range":
			...
			theRange, current, valueErr = xmlcommon.ReadText(
				decoder, current,
			)
			foundRange = true
		case "void":
			...
			theVoid, current, valueErr = xmlcommon.ReadText(
				decoder, current,
			)
			foundVoid = true
		default:
	...
	if !foundRange {
		err = missingProperty("range")
		return
	}

	if !foundVoid {
		err = missingProperty("void")
		return
	}
...
func writeSomethingAsSequence(
	...
	err = finishProperty(
		...
		xmlcommon.WriteElement(
			encoder, "interface", that.Interface(), xmlcommon.WriteAsText_string,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"Range()",
		xmlcommon.WriteElement(
			encoder, "range", that.Range(), xmlcommon.WriteAsText_string,
		),
	)
	if err != nil {
		return
	...
	err = finishProperty(
		"Void()",
		xmlcommon.WriteElement(
			encoder, "void", that.Void(), xmlcommon.WriteAsText_string,
		),
	)
	if err != nil {
		return

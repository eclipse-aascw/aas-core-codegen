...
func IsItem(
	...
	ok = that.ModelType() == ModelTypeItem
	return
}
...
// Create a new instance of Item with
...
func (s *Something) Numbers(
) []int64 {
	return s.numbers
}

func (s *Something) SetNumbers(
	value []int64,
) {
	s.numbers = value
}

func (s *Something) Texts(
) []string {
	return s.texts
}

func (s *Something) SetTexts(
	value []string,
) {
	s.texts = value
}

    ...
    public class TestXmlizationErrors
    {
        ...
        public void Test_error_on_unexpected_declaration()
        {
            ...
            if (!text.StartsWith("<leaf "))
            {
                throw new System.InvalidOperationException(
                    "We expect our test example in XML to start with '<leaf ', "
            ...
            try
            {
                Aas.Xmlization.Deserialize.LeafFrom(
                    xmlReader);
            }
            ...
            Assert.AreEqual(
                ...
                "class Leaf, as we expect the reader to be set at content " +
        ...
        public void Test_error_on_duplicate_property()
        {
            ...
            if (start >= 0)
            {
                ...
                property = text.Substring(start, end + 13 - start);
            }
            else
            {
            ...
            if (message == null)
            {
                throw new AssertionException(
                    "Expected an exception when the property "
                        + "identifier is given twice, but got none");
            }
        }

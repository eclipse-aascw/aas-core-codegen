...
namespace dummy
{
    ...
    public static class Xmlization
    {
            ...
            : Visitation.AbstractVisitorWithContext<Xml.XmlWriter>
        {
            ...
            {
                WriteProperty(
                    "label", "Label", that.Label, writer, Write_string);

                if (that.Color.HasValue)
                {
                    WriteProperty(
                        "color", "Color", that.Color.Value, writer, Write_Color);
                }
            }  // private static void BoxToSequence
                ...
                Xml.XmlWriter writer)
            {
                ...
                WriteProperty(
                    "tags", "Tags", that.Tags, writer, Write_ListOf_string);
            }  // private static void BagToSequence
            ...
            {
                WriteProperty(
                    "names", "Names", that.Names, writer, Write_ListOf_string);

...
namespace dummy
{
    public static class Visitation
    {
        ...
        public abstract class AbstractVisitor : IVisitor
        {
            ...
            public abstract void VisitBox(
                IBox that
            );
            public abstract void VisitBag(
                IBag that
            );
        ...
        public interface ITransformer<out T>
        {
            ...
            public T TransformBox(
                IBox that
            );
            public T TransformBag(
                IBag that
            );
        ...
        public abstract class AbstractTransformer<T> : ITransformer<T>
        {
            ...
            public abstract T TransformBox(
                IBox that
            );

            public abstract T TransformBag(
                IBag that
            );

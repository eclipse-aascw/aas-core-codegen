...
namespace dummy
{
    ...
    public static class Jsonization
    {
        ...
        internal static class DeserializeImplementation
        {
            ...
            /// <summary>
            /// Deserialize the enumeration Color from the <paramref name="node" />.
            /// </summary>
            /// <param name="node">JSON node to be parsed</param>
            /// <param name="error">Error, if any, during the deserialization</param>
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        "Not a valid JSON representation of Color");
                    return default!;
                }

                return result.Value;
            }  // internal static ColorFrom
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        $"Expected a JsonObject representing IItem, but got {Describe(node)}");
                    return default!;
                }
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        $"Expected a JsonObject representing Box, but got {Describe(node)}");
                    return default!;
                }
                    ...
                    switch (keyValue.Key)
                    {
                        ...
                        case "modelType":
                            modelType = StringFrom(
                                keyValue.Value, out error);
                            if (error == null && modelType != "Box")
                            {
                                error = new Reporting.Error(
                                    "Expected the model type 'Box', " +
                                    $"but got {modelType}");
                            }
                            break;
                        default:
                ...
                return new Aas.Box(
                    ...
                    theColor);
            }  // internal static BoxFrom

            /// <summary>
            /// Deserialize an instance of Bag from <paramref name="node" />.
            /// </summary>
            /// <param name="node">JSON node to be parsed</param>
            /// <param name="error">Error, if any, during the deserialization</param>
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        $"Expected a JsonObject representing Bag, but got {Describe(node)}");
                    return default!;
                }
                ...
                foreach (var keyValue in obj)
                {
                    switch (keyValue.Key)
                    {
                        case "label":
                            ...
                            break;
                        case "tags":
                            theTags = Parse_ListOf_string(
                                keyValue.Value, out error);
                            break;
                        case "modelType":
                            modelType = StringFrom(
                                keyValue.Value, out error);
                            if (error == null && modelType != "Bag")
                            {
                                error = new Reporting.Error(
                                    "Expected the model type 'Bag', " +
                                    $"but got {modelType}");
                            }
                            break;
                        default:
                ...
                {
                    error = new Reporting.Error(
                        "Required property \"tags\" is missing");
                    return default!;
                }
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        "Required property \"names\" is missing");
                    return default!;
                }
        ...
        {
            /// <summary>
            /// Deserialize an instance of Color from <paramref name="node" />.
            /// </summary>
            /// <param name="node">JSON node to be parsed</param>
            ...
            /// <summary>
            /// Deserialize an instance of IItem from <paramref name="node" />.
            /// </summary>
            /// <param name="node">JSON node to be parsed</param>
            /// <exception cref="Jsonization.Exception">
            /// Thrown when <paramref name="node" /> is not a valid JSON

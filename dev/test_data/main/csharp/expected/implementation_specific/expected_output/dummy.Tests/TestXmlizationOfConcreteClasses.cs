    ...
    public class TestXmlizationOfConcreteClasses
    {
        ...
        public void Test_Box_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.BoxFrom(
                    xmlReader);
        ...
        public void Test_Box_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.BoxFrom(
                            xmlReader);
                    }
        ...
        public void Test_Bag_ok()
        {
            ...
            foreach (var path in paths)
            {
                ...
                var instance = Aas.Xmlization.Deserialize.BagFrom(
                    xmlReader);
        ...
        public void Test_Bag_deserialization_fail()
        {
            ...
            )
            {
                ...
                foreach (var path in paths)
                {
                    ...
                    try
                    {
                        _ = Aas.Xmlization.Deserialize.BagFrom(
                            xmlReader);
                    }
                    catch (Aas.Xmlization.Exception observedException)
                    {

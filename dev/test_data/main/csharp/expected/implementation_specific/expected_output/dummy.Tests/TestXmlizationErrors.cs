        ...
        public void Test_error_on_unexpected_declaration()
        {
            ...
            if (!text.StartsWith("<box "))
            {
                throw new System.InvalidOperationException(
                    "We expect our test example in XML to start with '<box ', "
            ...
            try
            {
                Aas.Xmlization.Deserialize.BoxFrom(
                    xmlReader);
            }
            ...
            Assert.AreEqual(
                ...
                "class Box, as we expect the reader to be set at content " +
            ...
            if (message == null)
            {
                throw new AssertionException(
                    "Expected an exception when the property "
                        + "label is given twice, but got none");
            }
        }

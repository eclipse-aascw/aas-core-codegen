...
namespace dummy
{
    ...
    public static class Xmlization
    {
                ...
                out Reporting.Error? error)
            {
                ...
                if (!isEmptySequence)
                {
                    ...
                    if (reader.EOF)
                    {
                        error = new Reporting.Error(
                            ...
                            "a property of an instance of class Item, " +
                            "but reached the end-of-file");
                        return default!;
                    }
                            ...
                            out error))
                    {
                        switch (elementName)
                        {
                            ...
                            default:
                                error = new Reporting.Error(
                                    "We expected properties of the class Item, " +
                ...
                if (theTexts == null)
                {
                    error = new Reporting.Error(
                        ...
                        "in the XML representation of an instance of class Item");
                    return default!;
                }
        ...
        {
            /// <summary>
            /// Deserialize an instance of Item from <paramref name="reader" />.
            /// </summary>
                ...
                Xml.XmlReader reader)
            {
                ...
                if (!reader.EOF && reader.NodeType == Xml.XmlNodeType.XmlDeclaration)
                {
                    throw new Xmlization.Exception(
                        ...
                        "of class Item, as we expect the reader " +
            ...
            : Visitation.AbstractVisitorWithContext<Xml.XmlWriter>
        {
                ...
                Xml.XmlWriter writer)
            {
                ...
                WriteProperty(
                    "numbers", "Numbers", that.Numbers, writer, Write_ListOf_long);

    ...
    public static class Jsonization
    {
        ...
        internal static class DeserializeImplementation
        {
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        "Not a valid JSON representation of Kind");
                    return default!;
                }
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        $"Expected a JsonObject representing Item, but got {Describe(node)}");
                    return default!;
                }
        ...
        {
            /// <summary>
            /// Deserialize an instance of Kind from <paramref name="node" />.
            /// </summary>
            /// <param name="node">JSON node to be parsed</param>
            ...
            : Visitation.AbstractTransformer<Nodes.JsonObject>
        {
            ...
            )
            {
                ...
                SetProperty(result, "kind", "Kind", that.Kind, Serialize_Kind);

                SetProperty(result, "numbers", "Numbers", that.Numbers, Serialize_ListOf_long);
        ...
        public static class Serialize
        {
            ...
            /// Thrown when <paramref name="that" /> is no literal of Kind at all.

...
namespace dummy
{
    ...
    public static class Enhancing
    {
            ...
            where TEnhancement : class
        {
            ...
            {
                visitor.VisitItem(_instance, context);
            }

            public T Transform<T>(Visitation.ITransformer<T> transformer)
            {
                return transformer.TransformItem(_instance);
            }
            ...
            {
                return transformer.TransformItem(_instance, context);
            }
        }

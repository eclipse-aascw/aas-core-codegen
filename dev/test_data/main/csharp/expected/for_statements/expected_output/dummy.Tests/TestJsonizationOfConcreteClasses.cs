...
namespace dummy.Tests
{
    public class TestJsonizationOfConcreteClasses
    {
        ...
        [Test]
        public void Test_Item_deserialization_from_non_object_fail()
        {
            ...
            try
            {
                var _ = Aas.Jsonization.Deserialize.ItemFrom(
                    node);
            }
            ...
            if (
                !exception.Message.StartsWith(
                    "Expected a JsonObject representing Item, but got "))
            {
        ...
        [Test]
        public void Test_Item_deserialization_fail()
        {
            foreach (
                string causeDir in
        ...
        public void TestSomethingNumbersSerializationOutOfRange()
        {
            foreach (var value in new long[] { 9007199254740992L, -9007199254740992L })
            {
                ...
                instance.Numbers = new List<long>() { 0L, value };

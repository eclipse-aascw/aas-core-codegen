    ...
    public class TestXmlizationErrors
    {
        ...
        public void Test_error_on_unexpected_declaration()
        {
            ...
            if (!text.StartsWith("<item "))
            {
                throw new System.InvalidOperationException(
                    "We expect our test example in XML to start with '<item ', "
            ...
            try
            {
                Aas.Xmlization.Deserialize.ItemFrom(
                    xmlReader);
            }
            ...
            Assert.AreEqual(
                ...
                "class Item, as we expect the reader to be set at content " +
        ...
        public void Test_error_on_duplicate_property()
        {
            ...
            if (start >= 0)
            {
                ...
                property = text.Substring(start, end + 8 - start);
            }
            else
            {
            ...
            if (message == null)
            {
                throw new AssertionException(
                    "Expected an exception when the property "
                        + "texts is given twice, but got none");
            }
        }

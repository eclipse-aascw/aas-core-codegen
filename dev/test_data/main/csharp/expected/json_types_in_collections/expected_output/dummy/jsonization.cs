            ...
            : Visitation.AbstractTransformer<Nodes.JsonObject>
        {
            ...
            private static Nodes.JsonNode SerializeJsonValue(Nodes.JsonNode that)
            {
                ...
                Nodes.JsonNode result =
                    System.Text.Json.JsonSerializer.SerializeToNode(that)
                        ?? throw new System.InvalidOperationException(
                            "Expected SerializeToNode to copy the non-null JSON-able value " +
                                $"{that.ToJsonString()}, but it returned null");
                CheckIsJsonAbleForSerialization(result);
                return result;
            }
            ...
            )
            {
                ...
                result["values"] = Serialize_ListOf_jsonValue(
                    that.Values);

                result["tupleWithJson"] = Serialize_TupleOf4_string_jsonValue_jsonArray_jsonObject(
                    that.TupleWithJson);

...
namespace dummy
{
    ...
    public static class Jsonization
    {
        ...
        internal static class DeserializeImplementation
        {
            ...
            /// <summary>
            /// De-serialize a JSON array as a tuple of 4 item(s).
            /// </summary>
            /// <remarks>
            /// This is shared by all the tuple-typed properties of arity 4.
            /// </remarks>
            private static Deserializer<(T0, T1, T2, T3)> AsTuple4<T0, T1, T2, T3>(
                ...
                Deserializer<T3> deserializeItem3)
            {
                return (
                    ...
                    out Reporting.Error? error) =>
                    {
                        ...
                        {
                            error = new Reporting.Error(
                                $"Expected exactly 4 item(s) in the JsonArray, " +
                                $"but got: {array.Count}");
                            return default!;
                        }
            ...
            private static readonly Deserializer<List<Nodes.JsonNode>> Parse_ListOf_jsonValue = (
                AsArrayOf<Nodes.JsonNode>(
                    JsonValueFrom));

            private static readonly Deserializer<
                (string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject)
            > Parse_TupleOf4_string_jsonValue_jsonArray_jsonObject = (
                AsTuple4<string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject>(
                    StringFrom,
                    JsonValueFrom,
                    JsonArrayFrom,
                    JsonObjectFrom));
                ...
                out Reporting.Error? error)
            {
                ...
                List<Nodes.JsonNode>? theValues = null;
                (string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject)? theTupleWithJson = null;
                ...
                foreach (var keyValue in obj)
                {
                    ...
                    {
                        case "values":
                            theValues = Parse_ListOf_jsonValue(
                                keyValue.Value, out error);
                            break;
                        case "tupleWithJson":
                            theTupleWithJson = Parse_TupleOf4_string_jsonValue_jsonArray_jsonObject(
                                keyValue.Value, out error);
                            break;
                        default:
                            error = new Reporting.Error(
                ...
                {
                    error = new Reporting.Error(
                        "Required property \"tupleWithJson\" is missing");
                    return default!;
                }
            ...
            : Visitation.AbstractTransformer<Nodes.JsonObject>
        {
            ...
            /// <summary>
            /// Compose the serializer of a tuple of 4 item(s), whose items are
            /// serialized with <paramref name="serializeItem0" />,
            /// <paramref name="serializeItem1" />, *etc.*
            /// </summary>
            /// <remarks>
            /// This is shared by all the tuple-typed properties of arity 4. Just
            /// like for a list, the composition is performed once, when the field
            /// holding the result is initialized.
            /// </remarks>
            private static Serializer<(T0, T1, T2, T3)> SerializeTuple4<T0, T1, T2, T3>(
            ...
            private static readonly Serializer<List<Nodes.JsonNode>> Serialize_ListOf_jsonValue = (
                SerializeList<Nodes.JsonNode>(
                    Transformer.SerializeJsonValue));

            private static readonly Serializer<
                (string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject)
            > Serialize_TupleOf4_string_jsonValue_jsonArray_jsonObject = (
                SerializeTuple4<string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject>(
                    ToJsonValue,
                    Transformer.SerializeJsonValue,
            ...
            )
            {
                ...
                SetProperty(result, "values", "Values", that.Values, Serialize_ListOf_jsonValue);

...
namespace dummy
{
    ...
    public static class Xmlization
    {
        ...
        internal static class DeserializeImplementation
        {
            ...
            /// <summary>
            /// Read a content as a tuple of 4 item(s).
            /// </summary>
            /// <remarks>
            /// This is shared by everything of a tuple type of arity 4 -- be it
            /// a property, or a value nested in a list or in another tuple.
            /// </remarks>
            private static ContentReader<(T0, T1, T2, T3)> AsTuple4<T0, T1, T2, T3>(
                ...
                )
            {
                ...
                ) =>
                {
                    ...
                    {
                        error = new Reporting.Error(
                            "Expected an XML content representing a tuple of 4 item(s), " +
                            "but the element was self-closing");
                        return default!;
                    }
            ...
            private static readonly ContentReader<Nodes.JsonNode> Read_jsonValue = (
                ReadJsonValueContent);

            private static readonly ContentReader<List<Nodes.JsonNode>> Read_ListOf_jsonValue = (
                AsList<Nodes.JsonNode>(
                    AtElement(
                        Read_jsonValue, "v")));
            ...
            > Read_TupleOf4_string_jsonValue_jsonArray_jsonObject = (
                ...
                out Reporting.Error? error)
            {
                            ...
                            out error))
                    {
                        switch (elementName)
                        {
                            case "values":
                                ...
                                theValues = Read_ListOf_jsonValue(
                            ...
                            case "tupleWithJson":
                                ...
                                theTupleWithJson = Read_TupleOf4_string_jsonValue_jsonArray_jsonObject(
                                    reader, isEmptyProperty, out error);
                                break;
                            default:
                                error = new Reporting.Error(
                ...
                {
                    error = new Reporting.Error(
                        "The required property TupleWithJson has not been given " +
                        "in the XML representation of an instance of class Something");
                    return default!;
                }
            ...
            : Visitation.AbstractVisitorWithContext<Xml.XmlWriter>
        {
            ...
            /// <summary>
            /// Write a tuple of 4 item(s), each with its own <c>writeItem*</c>.
            /// </summary>
            /// <remarks>
            /// This is shared by everything of a tuple type of arity 4 -- be it
            /// a property, or a value nested in a list or in another tuple.
            /// </remarks>
            private static ContentWriter<(T0, T1, T2, T3)> WriteTuple4<T0, T1, T2, T3>(
            ...
            private static readonly ContentWriter<Nodes.JsonNode> Write_jsonValue = (
                WriteJsonValueContent);

            private static readonly ContentWriter<List<Nodes.JsonNode>> Write_ListOf_jsonValue = (
                WriteList<Nodes.JsonNode>(
                    WrapInElement(
                        Write_jsonValue, "v")));
            ...
            private static readonly ContentWriter<Nodes.JsonArray> Write_jsonArray = (
                WriteJsonArrayContent);

            private static readonly ContentWriter<Nodes.JsonObject> Write_jsonObject = (
                WriteJsonObjectContent);

            private static readonly ContentWriter<
                (string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject)
            > Write_TupleOf4_string_jsonValue_jsonArray_jsonObject = (
                WriteTuple4<string, Nodes.JsonNode, Nodes.JsonArray, Nodes.JsonObject>(
                    WrapInElement(
                        Write_string, "v1"),
                    WrapInElement(
                        Write_jsonValue, "v2"),
            ...
            private static void WriteJsonValueContent(
                ...
                Xml.XmlWriter writer)
            {
                XmlRpc.SerializeValueTo(that, writer, NS);
            }
            ...
            private static void WriteJsonArrayContent(
                ...
                Xml.XmlWriter writer)
            {
                XmlRpc.SerializeArrayBodyTo(that, writer, NS);
            }
            ...
            private static void WriteJsonObjectContent(
                ...
                Xml.XmlWriter writer)
            {
                XmlRpc.SerializeStructBodyTo(that, writer, NS);
            }
            ...
            {
                WriteElement(
                    "values", that.Values, writer, Write_ListOf_jsonValue);

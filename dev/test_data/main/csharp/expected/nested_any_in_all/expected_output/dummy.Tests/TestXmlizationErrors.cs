...
namespace dummy.Tests
{
    public class TestXmlizationErrors
    {
        ...
        public void Test_error_on_unexpected_declaration()
        {
            ...
            if (!text.StartsWith("<langString "))
            {
                throw new System.InvalidOperationException(
                    "We expect our test example in XML to start with '<langString ', "
            ...
            try
            {
                Aas.Xmlization.Deserialize.LangStringFrom(
                    xmlReader);
            }
            ...
            Assert.AreEqual(
                ...
                "class LangString, as we expect the reader to be set at content " +
        ...
        public void Test_error_on_duplicate_property()
        {
            ...
            if (start >= 0)
            {
                ...
                property = text.Substring(start, end + 11 - start);
            }
            else
            {
            ...
            if (message == null)
            {
                throw new AssertionException(
                    "Expected an exception when the property "
                        + "language is given twice, but got none");
            }
        }

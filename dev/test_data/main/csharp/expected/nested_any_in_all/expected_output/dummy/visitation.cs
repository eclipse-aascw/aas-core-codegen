...
namespace dummy
{
    public static class Visitation
    {
        ...
        public class VisitorThrough : IVisitor
        {
            ...
            public virtual void VisitLangStringSet(
                ILangStringSet that
            )
            {
                // Just descend through, do nothing with <c>that</c>
            ...
            public virtual void VisitIecContent(
                IIecContent that
            )
            {
                // Just descend through, do nothing with <c>that</c>
            ...
            public virtual void VisitOtherContent(
                IOtherContent that
            )
            {
                // Just descend through, do nothing with <c>that</c>
            ...
            public virtual void VisitSpecification(
                ISpecification that
            )
            {
                // Just descend through, do nothing with <c>that</c>
        ...
        public interface ITransformer<out T>
        {
            ...
            public T TransformLangStringSet(
                ILangStringSet that
            );
            public T TransformIecContent(
                IIecContent that
            );
            public T TransformOtherContent(
                IOtherContent that
            );
            public T TransformSpecification(
                ISpecification that
            );

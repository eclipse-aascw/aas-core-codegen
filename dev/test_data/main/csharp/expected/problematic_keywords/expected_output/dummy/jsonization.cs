    ...
    public static class Jsonization
    {
            ...
            : Visitation.AbstractTransformer<Nodes.JsonObject>
        {
            ...
            )
            {
                ...
                SetProperty(result, "interface", "Interface", that.Interface, Serialize_string);

                SetProperty(result, "type", "Type", that.Type, Serialize_string);

                SetProperty(result, "range", "Range", that.Range, Serialize_string);

                SetProperty(result, "void", "Void", that.Void, Serialize_string);

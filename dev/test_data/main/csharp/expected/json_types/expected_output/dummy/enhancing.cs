...
namespace dummy
{
    ...
    public static class Enhancing
    {
            ...
            where TEnhancement : class
        {
            ...
            public Nodes.JsonObject Mapping
            {
                get => _instance.Mapping;
                set => _instance.Mapping = value;
            }

            public Nodes.JsonObject MappingWithConstrainedKey
            {
                get => _instance.MappingWithConstrainedKey;
                set => _instance.MappingWithConstrainedKey = value;
            }

            public Nodes.JsonNode? OptionalValue
            {
                get => _instance.OptionalValue;
                set => _instance.OptionalValue = value;
            }

            public Nodes.JsonArray? OptionalValues
            {
                get => _instance.OptionalValues;
                set => _instance.OptionalValues = value;
            }

            public Nodes.JsonObject? OptionalMapping
            {
                get => _instance.OptionalMapping;
                set => _instance.OptionalMapping = value;
            }

...
namespace dummy
{
    ...
    public static class Jsonization
    {
                ...
                foreach (var keyValue in obj)
                {
                    switch (keyValue.Key)
                    {
                        ...
                        case "mappingWithConstrainedKey":
                            theMappingWithConstrainedKey = JsonObjectFrom(
                                keyValue.Value, out error);
                            break;
                        case "optionalValue":
                            theOptionalValue = JsonValueFrom(
                                keyValue.Value, out error);
                            break;
                        case "optionalValues":
                            theOptionalValues = JsonArrayFrom(
                                keyValue.Value, out error);
                            break;
            ...
            : Visitation.AbstractTransformer<Nodes.JsonObject>
        {
            ...
            private static readonly Serializer<Nodes.JsonNode> Serialize_JsonValue =
            ...
            )
            {
                ...
                SetProperty(result, "value", "Value", that.Value, Serialize_JsonValue);

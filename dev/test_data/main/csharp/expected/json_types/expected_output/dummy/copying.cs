...
namespace dummy
{
    ...
    public static class Copying
    {
        ...
        {    public override Aas.IClass TransformSomething(
            ...
            {
                return new Aas.Something(
                    (Nodes.JsonNode)that.Value.DeepClone(),
                    (Nodes.JsonArray)that.Values.DeepClone(),
                    (Nodes.JsonObject)that.Mapping.DeepClone(),
                    (Nodes.JsonObject)that.MappingWithConstrainedKey.DeepClone(),
                    (that.OptionalValue != null)
                        ? (Nodes.JsonNode)that.OptionalValue.DeepClone()
                        : null,
                    (that.OptionalValues != null)
                        ? (Nodes.JsonArray)that.OptionalValues.DeepClone()
                        : null,
                    (that.OptionalMapping != null)
                        ? (Nodes.JsonObject)that.OptionalMapping.DeepClone()
                        : null
                );
            }

    ...
    public static class Xmlization
    {
        ...
        internal static class DeserializeImplementation
        {
                ...
                out Reporting.Error? error)
            {
                            ...
                            out error))
                    {
                        switch (elementName)
                        {
                            ...
                            case "mappingWithConstrainedKey":
                                ...
                                theMappingWithConstrainedKey = Read_jsonObject(
                                    reader, isEmptyProperty, out error);
                                break;
                            case "optionalValue":
                                ...
                                theOptionalValue = Read_jsonValue(
                                    reader, isEmptyProperty, out error);
                                break;
                            case "optionalValues":
                                ...
                                theOptionalValues = Read_jsonArray(
                                    reader, isEmptyProperty, out error);
                                break;
                ...
                {
                    error = new Reporting.Error(
                        "The required property MappingWithConstrainedKey has not been given " +
                        "in the XML representation of an instance of class Something");
                    return default!;
                }
            ...
            : Visitation.AbstractVisitorWithContext<Xml.XmlWriter>
        {
            ...
            {
                WriteElement(
                    "value", that.Value, writer, Write_jsonValue);

                WriteElement(
                    "values", that.Values, writer, Write_jsonArray);

                WriteElement(
                    "mapping", that.Mapping, writer, Write_jsonObject);
                ...
                {
                    WriteElement(
                        "optionalValue", that.OptionalValue, writer, Write_jsonValue);
                }

                if (that.OptionalValues != null)
                {
                    WriteElement(
                        "optionalValues", that.OptionalValues, writer, Write_jsonArray);
                }

                if (that.OptionalMapping != null)
                {
                    WriteElement(
                        "optionalMapping", that.OptionalMapping, writer, Write_jsonObject);
                }
            }  // private static void SomethingToSequence

    ...
    public static class Xmlization
    {
        ...
        internal static class DeserializeImplementation
        {
                ...
                out Reporting.Error? error)
            {
                if (isEmptyProperty)
                {
                    error = new Reporting.Error(
                        ...
                        "<array> or <struct> as the content of the property, " +
                        "but the property element was self-closing");
                    return null;
                }

                return XmlRpc.DeserializeValueFrom(
                    reader, NS, out error);
            }
                ...
                out Reporting.Error? error)
            {
                ...
                {
                    error = new Reporting.Error(
                        "Expected a <data> element as the content of the property, " +
                        "but the property element was self-closing");
                    return null;
                }

                return XmlRpc.DeserializeArrayBodyFrom(
                    reader, NS, out error);
            }
                ...
                out Reporting.Error? error)
            {
                ...
                return XmlRpc.DeserializeStructBodyFrom(
                    reader, NS, out error);
            }
                ...
                if (!isEmptySequence)
                {
                    ...
                    while (true)
                    {
                        ...
                        switch (elementName)
                        {
                            case "value":
                            {
                                theValue = ParseJsonValueProperty(
                            ...
                            case "values":
                            {
                                theValues = ParseJsonArrayProperty(
                                    reader, isEmptyProperty, out error);
                                if (error != null)
                                {
                                    error.PrependSegment(
                            ...
                            case "mapping":
                            {
                                theMapping = ParseJsonObjectProperty(
                                    reader, isEmptyProperty, out error);
                                if (error != null)
                                {
                                    error.PrependSegment(
                            ...
                            {
                                theMappingWithConstrainedKey = ParseJsonObjectProperty(
                                    reader, isEmptyProperty, out error);
                                if (error != null)
                                {
                                    error.PrependSegment(
                            ...
                            case "optionalValue":
                            {
                                theOptionalValue = ParseJsonValueProperty(
                                    reader, isEmptyProperty, out error);
                                if (error != null)
                                {
                                    error.PrependSegment(
                            ...
                            case "optionalValues":
                            {
                                theOptionalValues = ParseJsonArrayProperty(
                                    reader, isEmptyProperty, out error);
                                if (error != null)
                                {
                                    error.PrependSegment(
                            ...
                            {
                                theOptionalMapping = ParseJsonObjectProperty(
                                    reader, isEmptyProperty, out error);
                                if (error != null)
                                {
                                    error.PrependSegment(

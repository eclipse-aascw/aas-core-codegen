...
namespace dummy
{
    ...
    public static class Xmlization
    {
        ...
        internal static class DeserializeImplementation
        {
            ...
            private static readonly ContentReader<(string, double)> Read_TupleOf2_string_double = (
                ...
                out Reporting.Error? error)
            {
                            ...
                            out error))
                    {
                        switch (elementName)
                        {
                            ...
                            case "someOptionalFloat":
                                ...
                                theSomeOptionalFloat = Read_double(
                                    reader, isEmptyProperty, out error);
                                break;
                            case "someFloats":
                            ...
                            case "somePair":
                                ...
                                theSomePair = Read_TupleOf2_string_double(
                                    reader, isEmptyProperty, out error);
                                break;
                            default:
                                error = new Reporting.Error(
                ...
                {
                    error = new Reporting.Error(
                        "The required property SomePair has not been given " +
                        "in the XML representation of an instance of class Something");
                    return default!;
                }
            ...
            : Visitation.AbstractVisitorWithContext<Xml.XmlWriter>
        {
            ...
            private static readonly ContentWriter<(string, double)> Write_TupleOf2_string_double = (
                WriteTuple2<string, double>(
                    WrapInElement(
                        Write_string, "v1"),
                    WrapInElement(
                        Write_double, "v2")));
                ...
                Xml.XmlWriter writer)
            {
                ...
                WriteProperty(
                    "someFloats", "SomeFloats", that.SomeFloats, writer, Write_ListOf_double);

                WriteProperty(
                    "somePair", "SomePair", that.SomePair, writer, Write_TupleOf2_string_double);
            }  // private static void SomethingToSequence

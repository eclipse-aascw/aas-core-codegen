...
namespace dummy
{
    ...
    public static class Jsonization
    {
        ...
        internal static class DeserializeImplementation
        {
            ...
            private static readonly Deserializer<(string, double)> Parse_TupleOf2_string_double = (
                AsTuple2<string, double>(
                    StringFrom,
                    DoubleFrom));
                ...
                out Reporting.Error? error)
            {
                ...
                (string, double)? theSomePair = null;
                ...
                foreach (var keyValue in obj)
                {
                    switch (keyValue.Key)
                    {
                        ...
                        case "someFloats":
                            ...
                            break;
                        case "somePair":
                            theSomePair = Parse_TupleOf2_string_double(
                                keyValue.Value, out error);
                            break;
                        case "someOptionalFloat":
                            theSomeOptionalFloat = DoubleFrom(
                                keyValue.Value, out error);
                            break;
                        default:
                            error = new Reporting.Error(
                ...
                {
                    error = new Reporting.Error(
                        "Required property \"somePair\" is missing");
                    return default!;
                }
            ...
            : Visitation.AbstractTransformer<Nodes.JsonObject>
        {
            ...
            private static readonly Serializer<
                (string, double)
            > Serialize_TupleOf2_string_double = (
                SerializeTuple2<string, double>(
                    ToJsonValue,
                    ToJsonValue));
            ...
            )
            {
                ...
                if (that.SomeOptionalFloat.HasValue)
                {
                    SetProperty(
                        result,
                        "someOptionalFloat",
                        "SomeOptionalFloat",
                        that.SomeOptionalFloat.Value,
                        Serialize_double);
                }

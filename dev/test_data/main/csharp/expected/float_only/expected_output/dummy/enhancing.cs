...
namespace dummy
{
    ...
    public static class Enhancing
    {
            ...
            where TEnhancement : class
        {
            ...
            public double? SomeOptionalFloat
            {
                get => _instance.SomeOptionalFloat;
                set => _instance.SomeOptionalFloat = value;
            }
            ...
            public (string, double) SomePair
            {
                get => _instance.SomePair;
                set => _instance.SomePair = value;
            }

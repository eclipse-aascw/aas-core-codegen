...
namespace dummy
{
    ...
    public static class Xmlization
    {
            ...
            : Visitation.AbstractVisitorWithContext<Xml.XmlWriter>
        {
            ...
            {
                WriteProperty(
                    "someBools", "SomeBools", that.SomeBools, writer, Write_ListOf_bool);

                WriteProperty(
                    "someInts", "SomeInts", that.SomeInts, writer, Write_ListOf_long);

                WriteProperty(
                    "someFloats", "SomeFloats", that.SomeFloats, writer, Write_ListOf_double);

                WriteProperty(
                    "someStrings", "SomeStrings", that.SomeStrings, writer, Write_ListOf_string);

                WriteProperty(
                    "someBytes", "SomeBytes", that.SomeBytes, writer, Write_ListOf_bytes);
            }  // private static void SomethingToSequence

...
function parseBoolVElement(
  cursor: XmlCursor
): AasCommon.Either<boolean, DeserializationError> {
  return parseNamedElement(cursor, "v", parseBooleanContent);
}

function parseBytesVElement(
  cursor: XmlCursor
): AasCommon.Either<Uint8Array, DeserializationError> {
  return parseNamedElement(cursor, "v", parseBase64EncodedBytesContent);
}

function parseFloatVElement(
  cursor: XmlCursor
): AasCommon.Either<number, DeserializationError> {
  return parseNamedElement(cursor, "v", parseFloatContent);
}

function parseIntVElement(
  cursor: XmlCursor
): AasCommon.Either<number, DeserializationError> {
  return parseNamedElement(cursor, "v", parseIntegerContent);
}

function parseListOfBoolContent(
  cursor: XmlCursor
): AasCommon.Either<Array<boolean>, DeserializationError> {
  return parseList<boolean>(cursor, parseBoolVElement);
}

function parseListOfBytesContent(
  cursor: XmlCursor
): AasCommon.Either<Array<Uint8Array>, DeserializationError> {
  return parseList<Uint8Array>(cursor, parseBytesVElement);
}

function parseListOfFloatContent(
  cursor: XmlCursor
): AasCommon.Either<Array<number>, DeserializationError> {
  return parseList<number>(cursor, parseFloatVElement);
}

function parseListOfIntContent(
  cursor: XmlCursor
): AasCommon.Either<Array<number>, DeserializationError> {
  return parseList<number>(cursor, parseIntVElement);
}

function parseListOfStrContent(
  cursor: XmlCursor
): AasCommon.Either<Array<string>, DeserializationError> {
  return parseList<string>(cursor, parseStrVElement);
}

function parseStrVElement(
  cursor: XmlCursor
): AasCommon.Either<string, DeserializationError> {
  return parseNamedElement(cursor, "v", parseStringContent);
}
  ...
  while (true) {
    ...
    switch (propertyLocalName) {
      case "someBools": {
        ...
        const parsed = parseElementContent(cursor, propertyLocalName, parseListOfBoolContent);
      ...
      case "someInts": {
        ...
        const parsed = parseElementContent(cursor, propertyLocalName, parseListOfIntContent);
        propertyError = parsed.error;
      ...
      case "someFloats": {
        ...
        const parsed = parseElementContent(cursor, propertyLocalName, parseListOfFloatContent);
        propertyError = parsed.error;
      ...
      case "someStrings": {
        ...
        const parsed = parseElementContent(cursor, propertyLocalName, parseListOfStrContent);
        propertyError = parsed.error;
      ...
      case "someBytes": {
        ...
        const parsed = parseElementContent(cursor, propertyLocalName, parseListOfBytesContent);
        propertyError = parsed.error;

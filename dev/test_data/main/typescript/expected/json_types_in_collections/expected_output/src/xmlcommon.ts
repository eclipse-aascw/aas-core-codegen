...
export const NAMESPACE = "https://dummy.com";
...
export function readNextOpenTagInNoNamespace(
  ...
  return readNextOpenTagInNamespace(cursor, "");
}
...
export function parseElementContentInNoNamespace<T>(
  ...
  return parseElementContentInNamespace(cursor, localName, parseContent, "");
}
...
export function parseNamedElementInNoNamespace<T>(
  ...
  return parseNamedElementInNamespace(
    cursor, expectedLocalName, parseContent, ""
  );
}

...
test("StructuralFirst deserialization fails on non-object", () => {
...
test("StructuralFirst deserialization fails with missing required property", () => {
  ...
  delete jsonObject["uniqueToFirst"];
...
test("StructuralFirst deserialization fails with property type mismatch", () => {
  const jsonable = readExpectedJson(
    "StructuralFirst",
    "minimal.json"
  );
  ...
  const jsonObject = { ...mustBeJsonObject(jsonable) };
  jsonObject["uniqueToFirst"] = { definitely: "unexpected-object" };

...
function parse_Kind(
  ...
  return parseEnumerationContent(
    cursor,
    "Kind",
    AasStringification.kindFromString
  );
}
...
function parseElement_Item(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.Item, DeserializationError> {
  return parseNamedElement(
    cursor,
    "item",
...
function parse_ListOf_Item(
  cursor: XmlCursor
): AasCommon.Either<Array<AasTypes.Item>, DeserializationError> {
  return parseList<AasTypes.Item>(
    cursor,
    parseElement_Item
  );
}
 ...
 * of {@link types!Item} is embedded.
 */
function parseItemFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.Item, DeserializationError> {
  ...
  if (theTexts === null) {
    return newDeserializationError<AasTypes.Item>(
      "The required property 'texts' is missing"
    );
  }

  const instance = new AasTypes.Item(
    theTexts
  );
  return new AasCommon.Either<AasTypes.Item, DeserializationError>(
    instance,

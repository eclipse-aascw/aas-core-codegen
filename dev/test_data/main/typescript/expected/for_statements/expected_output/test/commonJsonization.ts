...
/**
 * Load a maximal example of {@link types.Item} from
 * the test data directory.
 */
export function loadMaximalItem(
): AasTypes.Item {
  ...
  const casted = AasTypes.asItem(instance);
  if (casted === null) {
    throw new Error(
      `Expected instance of Item in ${aPath}, ` +
...
/**
 * Load a minimal example of {@link types.Item} from
 * the test data directory.
 */
export function loadMinimalItem(
): AasTypes.Item {
  const aPath = path.join(
    TestCommon.TEST_DATA_DIR,
    "Json",

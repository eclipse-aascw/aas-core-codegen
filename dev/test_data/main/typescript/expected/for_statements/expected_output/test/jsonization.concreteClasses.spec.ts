...
test("Item deserialization fail", () => {
  for (
    const causeDir of
...
test(
  ...
  () => {
    for (const value of [9007199254740992, -9007199254740992]) {
      ...
      instance.numbers = [0, value] as typeof instance.numbers;
      ...
      expect(caught.path).toStrictEqual(".numbers[1]");
    }
  }
);

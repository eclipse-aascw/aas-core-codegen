...
export class Something extends Class {
  ...
  optionalValue: JsonValue | null;

  optionalValues: JsonArray | null;
  ...
  *descend(): IterableIterator<Class> {
  ...
  constructor(
    ...
    mapping: JsonObject,
    mappingWithConstrainedKey: JsonObject,
    optionalValue: JsonValue | null = null,
    optionalValues: JsonArray | null = null,
    ...
    this.mappingWithConstrainedKey = mappingWithConstrainedKey;

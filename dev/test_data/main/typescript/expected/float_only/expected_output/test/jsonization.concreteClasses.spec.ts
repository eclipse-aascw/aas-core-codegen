...
test(
  "Something serialization fails on a non-finite number "
  + "at .someFloat",
  () => {
    for (const value of [Infinity, -Infinity, NaN]) {
      ...
      expect(caught.path).toStrictEqual(".someFloat");
    }
  }
);
...
test(
  ...
  () => {
    for (const value of [Infinity, -Infinity, NaN]) {
      ...
      instance.someFloats = [0.0, value] as typeof instance.someFloats;
      ...
      expect(caught.path).toStrictEqual(".someFloats[1]");
    }
  }
);
...
test(
  ...
  () => {
    for (const value of [Infinity, -Infinity, NaN]) {
      ...
      instance.somePair = [instance.somePair[0], value] as typeof instance.somePair;
      ...
      expect(caught.path).toStrictEqual(".somePair[1]");
    }
  }
);

...
function parse_TupleOf2_str_float(
  cursor: XmlCursor
...
function write_TupleOf2_str_float(
  parts: Array<string>,
  value: [string, number]
): void {
  writeTuple2(

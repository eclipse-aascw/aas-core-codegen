...
test("descendOnce of LangString", () => {
  const instance = TestCommonJsonization.loadMaximalLangString();
...
test("descendOnce of LangStringSet", () => {
  const instance = TestCommonJsonization.loadMaximalLangStringSet();
...
test("descendOnce of IecContent", () => {
...
test("descendOnce of OtherContent", () => {
  const instance = TestCommonJsonization.loadMaximalOtherContent();
...
test("descendOnce of Specification", () => {
  const instance = TestCommonJsonization.loadMaximalSpecification();

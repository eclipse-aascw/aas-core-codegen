...
function parseElement_LangString(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.LangString, DeserializationError> {
  return parseNamedElement(
    cursor,
    "langString",
    parseLangStringFromSequence
  );
}

function parseElement_LangStringSet(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.LangStringSet, DeserializationError> {
  return parseNamedElement(
    cursor,
    "langStringSet",
    parseLangStringSetFromSequence
  );
}

function parseElement_Specification(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.Specification, DeserializationError> {
  return parseNamedElement(
    cursor,
    "specification",
    parseSpecificationFromSequence
  );
}

function parse_ListOf_LangString(
  cursor: XmlCursor
): AasCommon.Either<Array<AasTypes.LangString>, DeserializationError> {
  return parseList<AasTypes.LangString>(
    cursor,
    parseElement_LangString
  );
}

function parse_ListOf_LangStringSet(
  cursor: XmlCursor
): AasCommon.Either<Array<AasTypes.LangStringSet>, DeserializationError> {
  return parseList<AasTypes.LangStringSet>(
    cursor,
    parseElement_LangStringSet
  );
}

function parse_ListOf_Specification(
  cursor: XmlCursor
): AasCommon.Either<Array<AasTypes.Specification>, DeserializationError> {
  return parseList<AasTypes.Specification>(
    cursor,
    parseElement_Specification
  );
}
 ...
 * of {@link types!LangString} is embedded.
 */
function parseLangStringFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.LangString, DeserializationError> {
  let theLanguage: string | null = null;
  let theText: string | null = null;

  const className = AasTypes.LangString.name;
  ...
  const instance = new AasTypes.LangString(
    theLanguage,
    theText
  );
  return new AasCommon.Either<AasTypes.LangString, DeserializationError>(
...
/**
 * Parse the sequence of properties of an instance
 * of {@link types!LangStringSet}.
 *
 * The opening tag is expected to have been already read by the caller, and
 * the caller is expected to read and verify the corresponding closing tag
 * after this function returns successfully. This is the contract of
 * a `ContentParser`, so this function is used as one wherever an instance
 * of {@link types!LangStringSet} is embedded.
 */
function parseLangStringSetFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.LangStringSet, DeserializationError> {
  let theLangStrings: Array<AasTypes.LangString> | null = null;

  const className = AasTypes.LangStringSet.name;
  ...
  while (true) {
    ...
    if (nextTagOrError instanceof DeserializationError) {
      return new AasCommon.Either<AasTypes.LangStringSet, DeserializationError>(
        null,
        nextTagOrError
      );
    }
    ...
    switch (propertyLocalName) {
      case "langStrings": {
        ...
        const parsed = parseElementContent(
          cursor,
          propertyLocalName,
          parse_ListOf_LangString
        );
        propertyError = parsed.error;
        theLangStrings = parsed.value;
        break;
      }
  ...
  if (theLangStrings === null) {
    return newDeserializationError<AasTypes.LangStringSet>(
      "The required property 'langStrings' is missing"
    );
  }

  const instance = new AasTypes.LangStringSet(
    theLangStrings
  );
  return new AasCommon.Either<AasTypes.LangStringSet, DeserializationError>(
    instance,
...
/**
 * Parse the sequence of properties of an instance
 * of {@link types!IecContent}.
 *
 * The opening tag is expected to have been already read by the caller, and
 * the caller is expected to read and verify the corresponding closing tag
 * after this function returns successfully. This is the contract of
 * a `ContentParser`, so this function is used as one wherever an instance
 * of {@link types!IecContent} is embedded.
 */
function parseIecContentFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.IecContent, DeserializationError> {
  let theDefinition: Array<AasTypes.LangString> | null = null;

  const className = AasTypes.IecContent.name;
  ...
  while (true) {
    ...
    if (nextTagOrError instanceof DeserializationError) {
      return new AasCommon.Either<AasTypes.IecContent, DeserializationError>(
        null,
        nextTagOrError
      );
    }
  ...
  const instance = new AasTypes.IecContent(
    theDefinition
  );
  return new AasCommon.Either<AasTypes.IecContent, DeserializationError>(
    instance,
...
/**
 * Parse the sequence of properties of an instance
 * of {@link types!OtherContent}.
 *
 * The opening tag is expected to have been already read by the caller, and
 * the caller is expected to read and verify the corresponding closing tag
 * after this function returns successfully. This is the contract of
 * a `ContentParser`, so this function is used as one wherever an instance
 * of {@link types!OtherContent} is embedded.
 */
function parseOtherContentFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.OtherContent, DeserializationError> {
  // No properties

  const className = AasTypes.OtherContent.name;
  ...
  while (true) {
    ...
    if (nextTagOrError instanceof DeserializationError) {
      return new AasCommon.Either<AasTypes.OtherContent, DeserializationError>(
        null,
        nextTagOrError
      );
    }
  ...
  const instance = new AasTypes.OtherContent();
  return new AasCommon.Either<AasTypes.OtherContent, DeserializationError>(
    instance,
    null
  );
...
/**
 * Parse the sequence of properties of an instance
 * of {@link types!Specification}.
 *
 * The opening tag is expected to have been already read by the caller, and
 * the caller is expected to read and verify the corresponding closing tag
 * after this function returns successfully. This is the contract of
 * a `ContentParser`, so this function is used as one wherever an instance
 * of {@link types!Specification} is embedded.
 */
function parseSpecificationFromSequence(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.Specification, DeserializationError> {
  let theContent: AasTypes.IContent | null = null;

  const className = AasTypes.Specification.name;
  ...
  while (true) {
    ...
    if (nextTagOrError instanceof DeserializationError) {
      return new AasCommon.Either<AasTypes.Specification, DeserializationError>(
        null,
        nextTagOrError
      );
    }
    ...
    switch (propertyLocalName) {
      case "content": {
        ...
        const parsed = parseElementContent(
          cursor,
          propertyLocalName,
          dispatchParseContentElement
        );
        propertyError = parsed.error;
        theContent = parsed.value;
        break;
      }
  ...
  if (theContent === null) {
    return newDeserializationError<AasTypes.Specification>(
      "The required property 'content' is missing"
    );
  }

  const instance = new AasTypes.Specification(
    theContent
  );
  return new AasCommon.Either<AasTypes.Specification, DeserializationError>(
    instance,
...
function parseSomethingFromSequence(
  ...
  let theDefaultLanguage: string | null = null;
  let theLangStringSets: Array<AasTypes.LangStringSet> | null = null;
  let theSpecifications: Array<AasTypes.Specification> | null = null;
  ...
  while (true) {
    ...
    switch (propertyLocalName) {
      case "defaultLanguage": {
        ...
        propertyError = parsed.error;
        theDefaultLanguage = parsed.value;
        break;
      }
      ...
      case "langStringSets": {
        ...
        const parsed = parseElementContent(
          cursor,
          propertyLocalName,
          parse_ListOf_LangStringSet
        );
        propertyError = parsed.error;
        theLangStringSets = parsed.value;
        break;
      }
      ...
      case "specifications": {
        ...
        const parsed = parseElementContent(
          cursor,
          propertyLocalName,
          parse_ListOf_Specification
        );
        propertyError = parsed.error;
        theSpecifications = parsed.value;
        break;
      }
 ...
 * of {@link types!LangString}, and neither the opening
 ...
 */
function writeLangStringAsSequence(
  parts: Array<string>,
...
/**
 * Write the properties of an instance
 * of {@link types!LangStringSet}, and neither the opening
 * nor the closing tag of the element which holds them -- which is the contract of
 * a `ContentWriter`, so this function is used as one.
 */
function writeLangStringSetAsSequence(
  parts: Array<string>,
...
/**
 * Write the properties of an instance
 * of {@link types!IecContent}, and neither the opening
 * nor the closing tag of the element which holds them -- which is the contract of
 * a `ContentWriter`, so this function is used as one.
 */
function writeIecContentAsSequence(
  parts: Array<string>,
...
/**
 * Write the properties of an instance
 * of {@link types!OtherContent}, and neither the opening
 * nor the closing tag of the element which holds them -- which is the contract of
 * a `ContentWriter`, so this function is used as one.
 */
function writeOtherContentAsSequence(
  parts: Array<string>,
...
/**
 * Write the properties of an instance
 * of {@link types!Specification}, and neither the opening
 * nor the closing tag of the element which holds them -- which is the contract of
 * a `ContentWriter`, so this function is used as one.
 */
function writeSpecificationAsSequence(
  parts: Array<string>,
...
const PARSERS_OF_CONTENT = new Map<
  string,
  ContentParser<AasTypes.IContent>
>([
  ["iecContent", parseIecContentFromSequence],
  ["otherContent", parseOtherContentFromSequence]
]);

/**
 * Dispatch-parse an instance
 * of {@link types!IContent} from the next
 * XML element in `cursor`, based on the element's local name.
 *
 * @param cursor - to read from
 * @returns the parsed instance, or an error
 */
function dispatchParseContentElement(
  cursor: XmlCursor
): AasCommon.Either<AasTypes.IContent, DeserializationError> {
 ...
 * of {@link types!IContent}.
 *
 * @param xml - XML string to parse
 * @returns parsed instance, or an error
 */
export function contentFromXmlString(
  xml: string
): AasCommon.Either<AasTypes.IContent, DeserializationError> {
  if (xml.length === 0) {
    return newDeserializationError<AasTypes.IContent>(
  ...
  if (tokensOrError.error !== null) {
    return new AasCommon.Either<AasTypes.IContent, DeserializationError>(
      null,
      tokensOrError.error
    );
  }
  ...
  const instanceOrError = dispatchParseContentElement(cursor);
...
>([
  ["langString", parseLangStringFromSequence],
  ["langStringSet", parseLangStringSetFromSequence],
  ["iecContent", parseIecContentFromSequence],
  ["otherContent", parseOtherContentFromSequence],
  ["specification", parseSpecificationFromSequence],

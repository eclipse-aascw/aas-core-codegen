...
test("descendOnce of OrderedContainer", () => {
  const instance = TestCommonJsonization.loadMaximalOrderedContainer();
...
test("descendOnce of UnorderedContainer", () => {
  const instance = TestCommonJsonization.loadMaximalUnorderedContainer();
...
test("descendOnce of GlobalAttribute", () => {
  const instance = TestCommonJsonization.loadMaximalGlobalAttribute();
...
test("descendOnce of LocalAttribute", () => {
  const instance = TestCommonJsonization.loadMaximalLocalAttribute();
...
test("descendOnce of AttributeOperand", () => {
  const instance = TestCommonJsonization.loadMaximalAttributeOperand();
...
test("descendOnce of StringLiteral", () => {
  const instance = TestCommonJsonization.loadMaximalStringLiteral();
...
test("descendOnce of NumberLiteral", () => {
  const instance = TestCommonJsonization.loadMaximalNumberLiteral();

...
class EnhancedItem
 ...
 public:
  ...
  EnhancedItem(
    std::shared_ptr<types::IItem> instance,
  ...
  virtual ~EnhancedItem() = default;

 private:
  std::shared_ptr<types::IItem> instance_;
...
class EnhancedSomething
 ...
 public:
  ...
  >& optional_items() const override {
    return instance_->optional_items();
  }
  ...
  >& mutable_optional_items() override {
    return instance_->mutable_optional_items();
  }
  ...
  void set_optional_items(
    ...
    instance_->set_optional_items(value);
  }
 ...
 */
template<typename E>
std::shared_ptr<types::IItem> WrapItem(

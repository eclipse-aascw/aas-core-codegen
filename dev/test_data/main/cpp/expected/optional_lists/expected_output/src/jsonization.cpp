...
/**
 * \brief Parse the properties of an instance of types::IItem.
 *
...
std::pair<
  ...
  >,
  common::optional<DeserializationError>
> ParsePropertiesOfItem(
  const nlohmann::json& json,
  bool additional_properties
);

/**
 * \brief Deserialize \p json to an instance of types::IItem.
 *
...
> DeserializeItem(
  ...
  return ParsePropertiesOfItem(json, additional_properties);
}

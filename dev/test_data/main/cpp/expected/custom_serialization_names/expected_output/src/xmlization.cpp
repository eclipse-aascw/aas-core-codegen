...
> ClassFromElement(
  ...
  >(
    ...
    L"IClass",
    types::ModelType::kQueryCondition,
    QueryConditionFromSequence<types::IClass>
  );
}
...
> QueryConditionFromElement(
  ...
  >(
    ...
    L"IQueryCondition",
    types::ModelType::kQueryCondition,
    QueryConditionFromSequence<types::IQueryCondition>
  );
}
...
const std::size_t kPropertyCountOfQueryCondition = 2;
...
> QueryConditionFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfQueryCondition
    >(
      reader,
      properties::kMapOfQueryCondition,
      L"IQueryCondition",
      [&](
        properties::OfQueryCondition property
      ) -> common::optional<DeserializationError> {
        switch (property) {
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeQueryConditionAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeQueryConditionAsElement(
  const types::IQueryCondition& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeQueryConditionAsElement(const types::IQueryCondition&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeQueryConditionPtrAsElement(
...
common::optional<xml_common::SerializationError> SerializeQueryConditionAsElement(
  ...
  return WriteElement(
    ...
    that,
    writer,
    SerializeQueryConditionAsSequence
  );
}
...
common::optional<xml_common::SerializationError> WriteClass(
  ...
  switch (that.model_type()) {
    case types::ModelType::kQueryCondition:
      return SerializeQueryConditionAsElement(
        dynamic_cast<

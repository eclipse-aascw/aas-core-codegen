...
/**
 * \brief Parse the properties of an instance of types::IQueryCondition.
 *
...
std::pair<
  ...
  >,
  common::optional<DeserializationError>
> ParsePropertiesOfQueryCondition(
  const nlohmann::json& json,
  bool additional_properties
);

/**
 * \brief Deserialize \p json to an instance of types::IQueryCondition.
 *
...
> DeserializeQueryCondition(
  ...
  return ParsePropertiesOfQueryCondition(json, additional_properties);
}

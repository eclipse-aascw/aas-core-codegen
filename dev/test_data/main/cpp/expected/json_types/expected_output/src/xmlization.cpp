    ...
    switch (property) {
      case properties::OfSomething::kValue: {
        ...
        std::tie(
          the_value,
          error
        ) = DeserializeJsonValueFromXmlRpc(reader);
        break;
      }
      ...
      case properties::OfSomething::kOptionalValue: {
        if (the_optional_value.has_value()) {
          error = DuplicatePropertyError(name);
          break;
        }
      ...
      case properties::OfSomething::kOptionalMapping: {
        if (the_optional_mapping.has_value()) {
          error = DuplicatePropertyError(name);
          break;
        }

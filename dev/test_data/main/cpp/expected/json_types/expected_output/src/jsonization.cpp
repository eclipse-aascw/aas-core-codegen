...
> kMapOfSomething = {
  ...
  },
  {
    ...
    OfSomething::kMappingWithConstrainedKey
  },
  {
    "optionalValue",
    OfSomething::kOptionalValue
  },
  {
    "optionalValues",
...
> ParsePropertiesOfSomething(
      ...
      [&](
        ...
        switch (property) {
          case properties::OfSomething::kValue:
            return ParseInto(
              the_value,
              DeserializeJsonValue(value)
            );
          case properties::OfSomething::kValues:
            return ParseInto(
              the_values,
              DeserializeJsonArray(value)
            );
          case properties::OfSomething::kMapping:
            return ParseInto(
              the_mapping,
              DeserializeJsonObject(value)
            );
          case properties::OfSomething::kMappingWithConstrainedKey:
            return ParseInto(
              the_mapping_with_constrained_key,
              DeserializeJsonObject(value)
            );
          case properties::OfSomething::kOptionalValue:
            return ParseInto(
              the_optional_value,
              DeserializeJsonValue(value)
            );
  ...
  if (!the_mapping_with_constrained_key.has_value()) {
    return NoInstanceAndDeserializationErrorWithCause<
      std::shared_ptr<types::ISomething>
    >(

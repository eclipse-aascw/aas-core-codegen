...
class EnhancedSomething
 ...
 public:
  ...
  nlohmann::json& mutable_mapping() override {
    return instance_->mutable_mapping();
  }
  ...
  common::optional<nlohmann::json>& mutable_optional_mapping() override {
    return instance_->mutable_optional_mapping();
  }

  void set_optional_mapping(
    common::optional<nlohmann::json> value
  ) override {
    instance_->set_optional_mapping(value);
  }

...
/// \brief Check that the \p text is not empty.
///
...
/// \brief Check that the \p text has more than one character.
///
...
/// \brief Check that the \p text has more than two characters.
///

...
/**
 * Deserialize an instance of types::IInstance from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IInstance, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IPointer from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IPointer, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IJsonObjectOfName from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IJsonObjectOfName, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IListOf from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IListOf, or an error if any
 */
common::expected<

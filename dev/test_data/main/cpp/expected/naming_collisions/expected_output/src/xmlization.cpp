...
template <
  ...
  typename std::enable_if<
    std::is_base_of<T, types::IInstance>::value
  >::type* = nullptr
>
std::pair<
...
template <
  typename T,
  typename std::enable_if<
    std::is_base_of<T, types::IPointer>::value
  >::type* = nullptr
>
std::pair<
  common::optional<std::shared_ptr<T> >,
...
template <
  typename T,
  typename std::enable_if<
    std::is_base_of<T, types::IJsonObjectOfName>::value
  >::type* = nullptr
>
std::pair<
  common::optional<std::shared_ptr<T> >,
  common::optional<DeserializationError>
> JsonObjectOfNameFromSequence(
  xml_common::ReaderMergingText& reader
);
...
template <
  typename T,
  typename std::enable_if<
    std::is_base_of<T, types::IListOf>::value
  >::type* = nullptr
>
std::pair<
  common::optional<std::shared_ptr<T> >,
...
> kElementNameToModelType = {
  {
    "instance",
    types::ModelType::kInstance
  },
  {
    "pointer",
    types::ModelType::kPointer
  },
  {
    "jsonObjectOfName",
    types::ModelType::kJsonObjectOfName
  },
  {
    "listOf",
    types::ModelType::kListOf
  },
  {
    "something",
    ...
    > {
      switch (a_model_type) {
        case types::ModelType::kInstance:
          return InstanceFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kPointer:
          return PointerFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kJsonObjectOfName:
          return JsonObjectOfNameFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kListOf:
          return ListOfFromSequence<
            types::IClass
          >(a_reader);
...
> InstanceFromElement(
  ...
  >(
    ...
    L"IInstance",
    types::ModelType::kInstance,
    InstanceFromSequence<types::IInstance>
  );
}
...
> PointerFromElement(
  ...
  >(
    ...
    L"IPointer",
    types::ModelType::kPointer,
    PointerFromSequence<types::IPointer>
  );
}
...
> JsonObjectOfNameFromElement(
  ...
  >(
    ...
    L"IJsonObjectOfName",
    types::ModelType::kJsonObjectOfName,
    JsonObjectOfNameFromSequence<types::IJsonObjectOfName>
  );
}
...
> ListOfFromElement(
  ...
  >(
    ...
    L"IListOf",
    types::ModelType::kListOf,
    ListOfFromSequence<types::IListOf>
  );
}
...
DeserializationError ConvertXmlRpcDeserializationError(
  xml_rpc::DeserializationError&& error
) {
  return DeserializationError(
...
xml_common::SerializationError ConvertXmlRpcSerializationError(
  xml_rpc::SerializationError&& error
) {
  xml_common::SerializationError result(std::move(error.cause));
  result.path = std::move(error.path);
  return result;
}
...
> DeserializeJsonValueFromXmlRpc(
  ...
  common::optional<xml_rpc::DeserializationError> xml_rpc_error;
  std::tie(value, xml_rpc_error) = xml_rpc::DeserializeValueFrom(reader);

  if (xml_rpc_error.has_value()) {
    return std::make_pair<
      common::optional<nlohmann::json>,
      common::optional<DeserializationError>
    >(
      common::nullopt,
      ConvertXmlRpcDeserializationError(std::move(*xml_rpc_error))
    );
  }
...
> DeserializeJsonArrayFromXmlRpc(
  ...
  common::optional<nlohmann::json> value;
  common::optional<xml_rpc::DeserializationError> xml_rpc_error;
  std::tie(value, xml_rpc_error) = xml_rpc::DeserializeArrayBodyFrom(reader);
...
> DeserializeJsonObjectFromXmlRpc(
  ...
  common::optional<nlohmann::json> value;
  common::optional<xml_rpc::DeserializationError> xml_rpc_error;
  std::tie(value, xml_rpc_error) = xml_rpc::DeserializeStructBodyFrom(reader);
...
const std::size_t kPropertyCountOfInstance = 1;
...
const std::size_t kPropertyCountOfPointer = 1;
...
const std::size_t kPropertyCountOfJsonObjectOfName = 1;
...
const std::size_t kPropertyCountOfListOf = 1;
...
> InstanceFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfInstance
    >(
      reader,
...
> PointerFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfPointer
    >(
      reader,
...
> JsonObjectOfNameFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfJsonObjectOfName
    >(
      reader,
...
> ListOfFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfListOf
    >(
      reader,
...
common::optional<xml_common::SerializationError> WriteJsonValueToXmlRpc(
  ...
  common::optional<xml_rpc::SerializationError> xml_rpc_error(
    xml_rpc::SerializeValueBodyTo(writer, value, true)
  );

  if (xml_rpc_error.has_value()) {
    return common::make_optional<xml_common::SerializationError>(
      ConvertXmlRpcSerializationError(std::move(*xml_rpc_error))
    );
  }
...
common::optional<xml_common::SerializationError> WriteJsonArrayToXmlRpc(
  ...
  common::optional<xml_rpc::SerializationError> xml_rpc_error(
    xml_rpc::SerializeArrayBodyTo(writer, value, true)
  );
...
common::optional<xml_common::SerializationError> WriteJsonObjectToXmlRpc(
  ...
  common::optional<xml_rpc::SerializationError> xml_rpc_error(
    xml_rpc::SerializeStructBodyTo(writer, value, true)
  );
...
template <
  ...
  typename WriteT1
>
common::optional<xml_common::SerializationError> WriteTuple2Property(
  const char* name,
  const std::tuple<T0, T1>& value,
  xml_common::SelfClosingWriter& writer,
  iteration::Property property,
  ...
  return WriteProperty(
    ...
    writer,
    property,
    [&write_item0, &write_item1](
      const std::tuple<T0, T1>& a_value,
      xml_common::SelfClosingWriter& a_writer
    ) -> common::optional<xml_common::SerializationError> {
      common::optional<xml_common::SerializationError> error;
...
common::optional<xml_common::SerializationError> WriteTuple2Property(
  const char* name,
  const common::optional<std::tuple<T0, T1> >& value,
  xml_common::SelfClosingWriter& writer,
  iteration::Property property,
  const WriteT0& write_item0,
  const WriteT1& write_item1
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeInstanceAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeInstanceAsElement(
  const types::IInstance& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeInstanceAsElement(const types::IInstance&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeInstancePtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializePointerAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializePointerAsElement(
  const types::IPointer& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializePointerAsElement(const types::IPointer&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializePointerPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeJsonObjectOfNameAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeJsonObjectOfNameAsElement(
  const types::IJsonObjectOfName& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeJsonObjectOfNameAsElement(const types::IJsonObjectOfName&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeJsonObjectOfNamePtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeListOfAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeListOfAsElement(
  const types::IListOf& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeListOfAsElement(const types::IListOf&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeListOfPtrAsElement(
...
common::optional<xml_common::SerializationError> SerializeInstancePtrAsElement(
  ...
  return SerializeInstanceAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializePointerPtrAsElement(
  ...
  return SerializePointerAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeJsonObjectOfNameAsElement(
  ...
  return WriteElement(
    ...
    that,
    writer,
    SerializeJsonObjectOfNameAsSequence
  );
}
...
common::optional<xml_common::SerializationError> SerializeJsonObjectOfNamePtrAsElement(
  ...
  return SerializeJsonObjectOfNameAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeListOfPtrAsElement(
  ...
  return SerializeListOfAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeSomethingAsSequence(
  ...
  error = WriteListOfInstancesProperty(
    ...
    that.instances(),
    writer,
    iteration::Property::kInstances,
    SerializeInstancePtrAsElement
  );
  if (error.has_value()) {
    return error;
  }
  ...
  error = WriteProperty(
    ...
    writer,
    iteration::Property::kJsonObjectOfName,
    SerializeJsonObjectOfNameAsSequence
  );
  if (error.has_value()) {
    return error;
  ...
  error = WriteListOfInstancesProperty(
    ...
    that.lists(),
    writer,
    iteration::Property::kLists,
    SerializeListOfPtrAsElement
  );
  if (error.has_value()) {
    return error;
  }

  error = WriteTuple2Property(
    "pair",
    that.pair(),
    writer,
    ...
    [](
      ...
      return WriteElement("v2", item, a_writer, WriteWstring);
    }
  );
  if (error.has_value()) {
    return error;
...
common::optional<xml_common::SerializationError> WriteClass(
  ...
  switch (that.model_type()) {
    case types::ModelType::kInstance:
      return SerializeInstanceAsElement(
        dynamic_cast<
          const types::IInstance&
        >(that),
        writer
      );
    case types::ModelType::kPointer:
      return SerializePointerAsElement(
        dynamic_cast<
          const types::IPointer&
        >(that),
        writer
      );
    case types::ModelType::kJsonObjectOfName:
      return SerializeJsonObjectOfNameAsElement(
        dynamic_cast<
          const types::IJsonObjectOfName&
        >(that),
        writer
      );
    case types::ModelType::kListOf:
      return SerializeListOfAsElement(
        dynamic_cast<
          const types::IListOf&
        >(that),
        writer

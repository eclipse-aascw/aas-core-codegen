...
/**
 * This iterator is always done as IInstance
 * references no other instances.
 */
class IteratorOverInstance : public impl::IIterator {
 public:
  IteratorOverInstance(
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverInstance, "
      "but the iterator is always done as "
      "IInstance references "
      "no other instances."
    );
  }
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverInstance>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverInstance, "
      "but the iterator is always done as "
      "IInstance references "
      "no other instances."
    );
  ...
  ~IteratorOverInstance() override = default;
};  // class IteratorOverInstance

/**
 * This iterator is always done as IPointer
 * references no other instances.
 */
class IteratorOverPointer : public impl::IIterator {
 public:
  IteratorOverPointer(
    const std::shared_ptr<types::IClass>&
  ) {
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverPointer, "
      "but the iterator is always done as "
      "IPointer references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverPointer>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverPointer, "
      "but the iterator is always done as "
      "IPointer references "
      "no other instances."
    );
  ...
  ~IteratorOverPointer() override = default;
};  // class IteratorOverPointer

/**
 * This iterator is always done as IJsonObjectOfName
 * references no other instances.
 */
class IteratorOverJsonObjectOfName : public impl::IIterator {
 public:
  IteratorOverJsonObjectOfName(
    const std::shared_ptr<types::IClass>&
  ) {
    // Intentionally empty.
  }
  ...
  void Next() override {
    throw std::logic_error(
      "You want to move "
      "an IteratorOverJsonObjectOfName, "
      "but the iterator is always done as "
      "IJsonObjectOfName "
      "references no other instances."
    );
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverJsonObjectOfName, "
      "but the iterator is always done as "
      "IJsonObjectOfName references "
      "no other instances."
    );
  }
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverJsonObjectOfName>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverJsonObjectOfName, "
      "but the iterator is always done as "
      "IJsonObjectOfName references "
      "no other instances."
    );
  ...
  ~IteratorOverJsonObjectOfName() override = default;
};  // class IteratorOverJsonObjectOfName

/**
 * This iterator is always done as IListOf
 * references no other instances.
 */
class IteratorOverListOf : public impl::IIterator {
 public:
  IteratorOverListOf(
    const std::shared_ptr<types::IClass>&
  ) {
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverListOf, "
      "but the iterator is always done as "
      "IListOf references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverListOf>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverListOf, "
      "but the iterator is always done as "
      "IListOf references "
      "no other instances."
    );
  ...
  ~IteratorOverListOf() override = default;
};  // class IteratorOverListOf
  ...
  while (true) {
    switch (state_) {
      case 0: {
        ...
        property_ = Property::kInstances;

        cursor_ = 0;
      }

      case 1: {
        if (!(*cursor_ < casted_->instances().size())) {
          state_ = 3;
          continue;
        }
        ...
        const auto& item_value = the_instances[*cursor_];
      ...
      case 4: {
        property_ = Property::kJsonObjectOfName;
        item_ = std::static_pointer_cast<types::IClass>(
          casted_->json_object_of_name()
        );
        ++index_;
      ...
      case 5: {
        property_ = Property::kLists;

        cursor_ = 0;
      }

      case 6: {
        if (!(*cursor_ < casted_->lists().size())) {
          state_ = 8;
          continue;
        }
        ...
        const auto& item_value = the_lists[*cursor_];
      ...
      case 8: {
        ...
        property_ = Property::kPair;

        cursor_ = 0;
        item_ = std::static_pointer_cast<types::IClass>(
          std::get<0>(casted_->pair())
        );
        ++index_;
...
std::unique_ptr<impl::IIterator> NewNonRecursiveIterator(
  ...
  switch (instance->model_type()) {
    case types::ModelType::kInstance:
      return common::make_unique<IteratorOverInstance>(
        instance
      );
    case types::ModelType::kPointer:
      return common::make_unique<IteratorOverPointer>(
        instance
      );
    case types::ModelType::kJsonObjectOfName:
      return common::make_unique<IteratorOverJsonObjectOfName>(
        instance
      );
    case types::ModelType::kListOf:
      return common::make_unique<IteratorOverListOf>(
        instance
      );

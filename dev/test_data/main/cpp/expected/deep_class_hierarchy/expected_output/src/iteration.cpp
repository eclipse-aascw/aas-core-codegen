...
std::unique_ptr<impl::IIterator> Over_Something(
  ...
  return Chain(
    InProperty(
      Property::kSomeChoice,
      OneThenOver(that.some_choice(), recursive)
    ),
    InProperty(
      Property::kSomethingWithoutChoice,
      OneThenOver(that.something_without_choice(), recursive)
    )
  );
}
...
std::unique_ptr<impl::IIterator> Over_Container(
  ...
  return Chain(
    InProperty(
      Property::kNode,
      OneThenOver(that.node(), recursive)
    ),
    InProperty(
      Property::kSomething,
      OneThenOver(that.something(), recursive)
    )
  );
}

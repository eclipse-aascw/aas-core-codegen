...
const std::size_t kPropertyCountOfBranch = 2;
...
const std::size_t kPropertyCountOfLeaf = 3;
...
const std::size_t kPropertyCountOfBlossom = 4;
...
> BranchFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfBranch
    >(
      reader,
...
> BlossomFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfBlossom
    >(
      reader,

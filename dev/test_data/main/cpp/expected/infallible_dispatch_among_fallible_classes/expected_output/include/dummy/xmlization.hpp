...
/**
 * Deserialize an instance of types::IAbstractWithoutNumbers from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IAbstractWithoutNumbers, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IAbstractDescendantWithoutNumbers from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IAbstractDescendantWithoutNumbers, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IParentWithoutNumbers from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IParentWithoutNumbers, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IChildWithoutNumbers from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IChildWithoutNumbers, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IWithNumber from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IWithNumber, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::UnionWithoutNumbers from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::UnionWithoutNumbers, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::UnionWithNumbers from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::UnionWithNumbers, or an error if any
 */
common::expected<

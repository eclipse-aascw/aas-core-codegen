...
std::wstring PropertyToWstring(
  ...
  switch (property) {
    case Property::kAbstractProperty:
      return L"abstract_property";
    case Property::kAnotherText:
      return L"another_text";
    case Property::kListAbstractProperty:
      return L"list_abstract_property";
    case Property::kOptionalParentProperty:
      return L"optional_parent_property";
    case Property::kParentProperty:
      return L"parent_property";
    case Property::kSomeInt:
      return L"some_int";
    case Property::kSomeText:
      return L"some_text";
    case Property::kUnionWithNumbersProperty:
      return L"union_with_numbers_property";
    case Property::kUnionWithoutNumbersProperty:
      return L"union_without_numbers_property";
    default:
...
using listOf_AbstractWithoutNumbers = std::vector<
  std::shared_ptr<types::IAbstractWithoutNumbers>
>;

std::unique_ptr<impl::IIterator> Over_listOf_AbstractWithoutNumbers(
  const listOf_AbstractWithoutNumbers& value,
  bool recursive
) {
  return Each(
    value,
    &OneThenOver<types::IAbstractWithoutNumbers>,
    recursive
  );
}

std::unique_ptr<impl::IIterator> Over_UnionWithoutNumbers(
  const types::UnionWithoutNumbers& value,
  bool recursive
) {
  switch (value.index()) {
    case 0:
...
std::unique_ptr<impl::IIterator> Over_UnionWithNumbers(
  const types::UnionWithNumbers& value,
  bool recursive
) {
  switch (value.index()) {
    case 0:
...
std::unique_ptr<impl::IIterator> Over_Something(
  ...
  return Chain(
    InProperty(
      Property::kAbstractProperty,
      OneThenOver(that.abstract_property(), recursive)
    ),
    InProperty(
      Property::kParentProperty,
      OneThenOver(that.parent_property(), recursive)
    ),
    InProperty(
      Property::kListAbstractProperty,
      Over_listOf_AbstractWithoutNumbers(
        that.list_abstract_property(),
        recursive
      )
    ),
    InProperty(
      Property::kOptionalParentProperty,
      that.optional_parent_property().has_value()
        ? OneThenOver((*that.optional_parent_property()), recursive)
        : Empty()
    ),
    InProperty(
      Property::kUnionWithoutNumbersProperty,
      Over_UnionWithoutNumbers(
        that.union_without_numbers_property(),
        recursive
      )
    ),
    InProperty(
      Property::kUnionWithNumbersProperty,
      Over_UnionWithNumbers(

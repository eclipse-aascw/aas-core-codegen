...
TEST_CASE("Test verification of a valid AbstractDescendantWithoutNumbers") {
...
TEST_CASE("Test verification of invalid cases for AbstractDescendantWithoutNumbers") {
  for (
...
TEST_CASE("Test verification of a valid ParentWithoutNumbers") {
  const std::deque<std::filesystem::path> paths(
    test::common::FindFilesBySuffixRecursively(
      DetermineXmlDir()
        / "Expected"
...
TEST_CASE("Test verification of invalid cases for ParentWithoutNumbers") {
  for (
    const std::filesystem::path& causeDir
    : test::common::ListSubdirectories(
      DetermineXmlDir()
...
TEST_CASE("Test verification of a valid ChildWithoutNumbers") {
  const std::deque<std::filesystem::path> paths(
    test::common::FindFilesBySuffixRecursively(
      DetermineXmlDir()
        / "Expected"
...
TEST_CASE("Test verification of invalid cases for ChildWithoutNumbers") {
  for (
    const std::filesystem::path& causeDir
    : test::common::ListSubdirectories(
      DetermineXmlDir()
...
TEST_CASE("Test verification of a valid WithNumber") {
  const std::deque<std::filesystem::path> paths(
    test::common::FindFilesBySuffixRecursively(
      DetermineXmlDir()
        / "Expected"
...
TEST_CASE("Test verification of invalid cases for WithNumber") {
  for (
    const std::filesystem::path& causeDir
    : test::common::ListSubdirectories(
      DetermineXmlDir()

...
std::wstring PropertyToWstring(
  ...
  switch (property) {
    ...
    case Property::kItems:
      return L"items";
    case Property::kLabel:
      return L"label";
    case Property::kNames:
      return L"names";
    case Property::kTags:
      return L"tags";
    default:
...
/**
 * This iterator is always done as IBox
 * references no other instances.
 */
class IteratorOverBox : public impl::IIterator {
 public:
  IteratorOverBox(
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverBox, "
      "but the iterator is always done as "
      "IBox references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverBox>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverBox, "
      "but the iterator is always done as "
      "IBox references "
      "no other instances."
    );
  ...
  ~IteratorOverBox() override = default;
};  // class IteratorOverBox

/**
 * This iterator is always done as IBag
 * references no other instances.
 */
class IteratorOverBag : public impl::IIterator {
 public:
  IteratorOverBag(
    const std::shared_ptr<types::IClass>&
  ) {
  ...
  const std::shared_ptr<types::IClass>& Get() const override {
    throw std::logic_error(
      "You want to get from an IteratorOverBag, "
      "but the iterator is always done as "
      "IBag references "
      "no other instances."
    );
  ...
  std::unique_ptr<impl::IIterator> Clone() const override {
    return common::make_unique<IteratorOverBag>(*this);
  }

  void PrependToPath(Path*) const override {
    throw std::logic_error(
      "You want to prepend to path from an IteratorOverBag, "
      "but the iterator is always done as "
      "IBag references "
      "no other instances."
    );
  ...
  ~IteratorOverBag() override = default;
};  // class IteratorOverBag
...
std::unique_ptr<impl::IIterator> NewNonRecursiveIterator(
  ...
  switch (instance->model_type()) {
    case types::ModelType::kBox:
      return common::make_unique<IteratorOverBox>(
        instance
      );
    case types::ModelType::kBag:
      return common::make_unique<IteratorOverBag>(
        instance
      );
...
const std::vector<types::Color> kOverColor = {
  types::Color::kRed,
  types::Color::kGreen
};

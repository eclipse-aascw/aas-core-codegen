    ...
    > {
      switch (a_model_type) {
        case types::ModelType::kBox:
          return BoxFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kBag:
          return BagFromSequence<
            types::IClass
          >(a_reader);
...
> ItemFromElement(
  ...
  return DeserializeClassFromElement<types::IItem>(
    reader,
    L"IItem",
    [](
      ReaderMergingText& a_reader,
...
> BoxFromElement(
  ...
  return DeserializeClassFromElement<types::IBox>(
    reader,
    L"IBox",
    [](
      ReaderMergingText& a_reader,
      ...
      common::optional<std::shared_ptr<types::IBox> >,
      common::optional<DeserializationError>
    > {
      switch (a_model_type) {
        case types::ModelType::kBox:
...
> BagFromElement(
  ...
  return DeserializeClassFromElement<types::IBag>(
    reader,
    L"IBag",
    [](
      ReaderMergingText& a_reader,
      ...
      common::optional<std::shared_ptr<types::IBag> >,
      common::optional<DeserializationError>
    > {
      switch (a_model_type) {
        case types::ModelType::kBag:
...
> DeserializeColor(
  ...
  if (error.has_value()) {
    ...
    >(
      common::Concat(
        L"Failed to de-serialize a literal of Color: ",
        error->cause
      )
    );
  }
  ...
  common::optional<
    types::Color
  > deserialized = wstringification::ColorFromWstring(
    *text
  );
  ...
  if (!deserialized.has_value()) {
    ...
    >(
      common::Concat(
        L"Expected a literal of Color, but got: ",
        *text
      )
    );
  }
...
> BoxFromSequence(
  ...
  if (reader.node().kind() == NodeKind::Error) {
    throw std::logic_error(
      "Unexpected unhandled XML error in BoxFromSequence. "
      "BoxFromSequence expects no reader error at entry."
    );
  }
  #endif
  ...
  while (true) {
    ...
    auto it = properties::kMapOfBox.find(
      name
    );
    if (it == properties::kMapOfBox.end()) {
      return NoInstanceAndDeserializationErrorWithCause<
        std::shared_ptr<T>
      >(
        common::Concat(
    ...
    const properties::OfBox property(
      it->second
    );
...
> BagFromSequence(
  ...
  if (reader.node().kind() == NodeKind::Error) {
    throw std::logic_error(
      "Unexpected unhandled XML error in BagFromSequence. "
      "BagFromSequence expects no reader error at entry."
    );
  }
  #endif
  ...
  while (true) {
    ...
    auto it = properties::kMapOfBag.find(
      name
    );
    if (it == properties::kMapOfBag.end()) {
      return NoInstanceAndDeserializationErrorWithCause<
        std::shared_ptr<T>
      >(
        common::Concat(
    ...
    const properties::OfBag property(
      it->second
    );
...
/**
 * Serialize the literal of Color
 * to XML text.
 */
common::optional<SerializationError> SerializeColor(
  types::Color that,
  SelfClosingWriter& writer
) {
 ...
 * \return error, if any
 */
common::optional<SerializationError> SerializeItemAsElement(
  const types::IItem& that,
  SelfClosingWriter& writer
);

/** @copybrief SerializeItemAsElement(const types::IItem&, SelfClosingWriter& */
common::optional<SerializationError> SerializeItemPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<SerializationError> SerializeBoxAsSequence(
 ...
 */
common::optional<SerializationError> SerializeBoxAsElement(
  const types::IBox& that,
  SelfClosingWriter& writer
);

/** @copybrief SerializeBoxAsElement(const types::IBox&, SelfClosingWriter& */
common::optional<SerializationError> SerializeBoxPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<SerializationError> SerializeBagAsSequence(
 ...
 * \return an error, if any
 */
common::optional<SerializationError> SerializeBagAsElement(
  const types::IBag& that,
  SelfClosingWriter& writer
);

/** @copybrief SerializeBagAsElement(const types::IBag&, SelfClosingWriter& */
common::optional<SerializationError> SerializeBagPtrAsElement(
...
common::optional<SerializationError> SerializeBoxPtrAsElement(
  ...
  return SerializeBoxAsElement(*that, writer);
}
...
common::optional<SerializationError> SerializeBagPtrAsElement(
  ...
  return SerializeBagAsElement(*that, writer);
}
...
common::optional<SerializationError> SerializeContainerAsSequence(
  ...
  error = SerializePropertyAsElement(
    ...
    [](
      const std::vector<std::shared_ptr<types::IItem>>& a_list,
      SelfClosingWriter& a_writer
    ) {
      return SerializeListOfInstances(a_list, a_writer, SerializeItemPtrAsElement);
    }
  );
  if (error.has_value()) {
    return error;

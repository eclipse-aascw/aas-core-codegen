...
common::optional<xml_common::SerializationError> SerializeListOfVElements(
  ...
  for (size_t i = 0; i < list.size(); ++i) {
    ...
    if (writer.error().has_value()) {
      common::optional<xml_common::SerializationError>&& error = writer.move_error();
      error->path.segments.emplace_front(
 ...
 * to XML text.
 */
common::optional<xml_common::SerializationError> SerializeColor(
  types::Color that,
  xml_common::SelfClosingWriter& writer
) {
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeItemAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeBoxAsSequence(
 ...
 */
common::optional<xml_common::SerializationError> SerializeBoxAsElement(
  const types::IBox& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeBoxAsElement(const types::IBox&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeBoxPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeBagAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeBagAsElement(
  const types::IBag& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeBagAsElement(const types::IBag&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeBagPtrAsElement(

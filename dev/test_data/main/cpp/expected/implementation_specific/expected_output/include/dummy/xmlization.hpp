...
/**
 * Deserialize an instance of types::IItem from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IItem, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IBox from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IBox, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IBag from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IBag, or an error if any
 */
common::expected<

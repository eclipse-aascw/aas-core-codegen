...
>
common::optional<SerializationError> SerializeTuple2(
  const std::tuple<
    T0,
    T1
  >& value,
...
>
common::optional<SerializationError> SerializeTuple6(
  const std::tuple<
    T0,
    T1,
    T2,
    ...
    [](
      ...
      return SerializeTuple2(
        ...
        [](
          ...
          common::optional<SerializationError> error = SerializeInt64(
            item,
            a_writer
          );
          if (error.has_value()) {
    ...
    [](
      ...
      return SerializeTuple6(
        ...
        [](
          ...
          common::optional<SerializationError> error = SerializeResult(
            item,
            a_writer
          );
          if (error.has_value()) {

...
bool LastCharacterIsNotZ(
  ...
  return (
    (
      ...
      && common::SliceStr(text, -100, 100) == text
      && common::SliceStr(text, 3, 1) == L""
      && common::FindStr(text, L"", 100) == -1
      && common::FindStr(text, common::SliceStr(text, position), position) >= 0
    )
  );
}

bool NameStartsWithPrefix(
...
bool NameHasNoSpaceAfterPrefix(
  const std::wstring& name
) {
  return (
    (
...
bool Something_1(
  ...
  return verification::NameHasNoSpaceAfterPrefix(
    that->name()
  );
}
...
bool Something_2(
  ...
  return verification::NameStartsWithPrefix(
    that->name()
  );
}
...
bool Something_3(
  ...
  return verification::LastCharacterIsNotZ(
    that->text()
  );
}
...
bool Something_4(
  ...
  return verification::SecondsFollowColon(
    that->text()
  );
}
...
bool Something_5(
  ...
  return verification::MonthIsSeptember(
    that->text()
  );
}
...
bool Something_6(
  ...
  return verification::TimeAfterDateIsLongEnough(
    that->text()
  );
}
...
bool Something_7(
  ...
  return verification::DateBeforeTimeIsLongEnough(
    that->text()
  );
}
  ...
  switch (shape) {
    ...
    case Shape::kSomething: {
      static const std::vector<Check> checks = {
        {
          &Something_0,
          L"Text must not start with X"
        },
        {
          &Something_1,
          L"Name must contain no space after the prefix"
        },
        {
          &Something_2,
          L"Name must start with the prefix"
        },
        {
          &Something_3,
          L"Last character must not be Z"
        },
        {
          &Something_4,
          L"Seconds must follow a colon"
        },
        {
          &Something_5,
          L"Month must be September"
        },
        {
          &Something_6,
          L"Time after the date must have 8 characters"
        },
        {
          &Something_7,
          L"Date before the time must have 10 characters"
        }
      };
      return checks;
    }
...
std::unique_ptr<IIterator> Over_Something(
  ...
  return Chain(
    ...
    InProperty(
      ...
      One(&that.name(), Shape::kNonEmptyString)
    )
  );
}

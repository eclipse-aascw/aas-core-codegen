...
TEST_CASE("Test the round-trip of an expected Item") {
...
TEST_CASE("Test the de-serialization failure on an unexpected Item") {
  for (
...
TEST_CASE("Test the de-serialization failure on a duplicate property") {
  ...
  INFO(aas::common::Concat("Looking for </item> in ", path.string()))

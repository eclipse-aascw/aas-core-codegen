...
> DeserializeKind(
  ...
  if (error.has_value()) {
    ...
    >(
      common::Concat(
        L"Failed to de-serialize a literal of Kind: ",
        error->cause
      )
    );
  }
  ...
  common::optional<
    types::Kind
  > deserialized = wstringification::KindFromWstring(
    *text
  );
  ...
  if (!deserialized.has_value()) {
    ...
    >(
      common::Concat(
        L"Expected a literal of Kind, but got: ",
        *text
      )
    );
  }
...
> ItemFromSequence(
  ...
  common::optional<std::vector<std::wstring> > the_texts;
...
> SomethingFromSequence(
  ...
  common::optional<types::Kind> the_kind;

  common::optional<std::vector<int64_t> > the_numbers;
  ...
  common::optional<DeserializationError> error(
    ...
    >(
      ...
      [&](
        ...
        switch (property) {
          case properties::OfSomething::kKind:
            return ReadInto(
              the_kind,
              DeserializeKind(reader)
            );
          case properties::OfSomething::kNumbers:
            return ReadInto(
              the_numbers,
              DeserializeList<
                int64_t
          ...
          case properties::OfSomething::kTexts:
            return ReadInto(
              the_texts,
              DeserializeList<
                std::wstring

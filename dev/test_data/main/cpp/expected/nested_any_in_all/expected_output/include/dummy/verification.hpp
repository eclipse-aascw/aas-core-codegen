...
/// \brief Check that \p language denotes English.
bool IsEnglish(
  const std::wstring& language
);

/// \brief Check that every set in \p lang_string_sets has at least one
/// string in English.
///
...
/// \brief Check that the types::IIecContent::definition is defined at least in English
/// for all the specifications whose content is an types::IIecContent.
///

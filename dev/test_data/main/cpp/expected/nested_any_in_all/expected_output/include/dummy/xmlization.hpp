...
/**
 * Deserialize an instance of types::ILangString from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::ILangString, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::ILangStringSet from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::ILangStringSet, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IContent from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IContent, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IIecContent from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IIecContent, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::IOtherContent from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::IOtherContent, or an error if any
 */
common::expected<
...
/**
 * Deserialize an instance of types::ISpecification from an XML
 * read from the stream \p is.
 *
 * \param is stream to read XML from
 * \param options reading options to be tweaked for special cases. The defaults should
 * work in most cases.
 * \return the parsed types::ISpecification, or an error if any
 */
common::expected<

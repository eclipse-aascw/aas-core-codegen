...
template <
  ...
  typename std::enable_if<
    std::is_base_of<T, types::ILangString>::value
  >::type* = nullptr
>
std::pair<
...
template <
  typename T,
  typename std::enable_if<
    std::is_base_of<T, types::ILangStringSet>::value
  >::type* = nullptr
>
std::pair<
  common::optional<std::shared_ptr<T> >,
...
template <
  typename T,
  typename std::enable_if<
    std::is_base_of<T, types::ISpecification>::value
  >::type* = nullptr
>
std::pair<
  common::optional<std::shared_ptr<T> >,
  common::optional<DeserializationError>
> SpecificationFromSequence(
  xml_common::ReaderMergingText& reader
);
    ...
    > {
      switch (a_model_type) {
        case types::ModelType::kLangString:
          return LangStringFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kLangStringSet:
          return LangStringSetFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kIecContent:
          return IecContentFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kOtherContent:
          return OtherContentFromSequence<
            types::IClass
          >(a_reader);
        case types::ModelType::kSpecification:
          return SpecificationFromSequence<
            types::IClass
          >(a_reader);
...
> LangStringFromElement(
  ...
  >(
    ...
    L"ILangString",
    types::ModelType::kLangString,
    LangStringFromSequence<types::ILangString>
  );
}
...
> LangStringSetFromElement(
  ...
  >(
    ...
    L"ILangStringSet",
    types::ModelType::kLangStringSet,
    LangStringSetFromSequence<types::ILangStringSet>
  );
}
...
> ContentFromElement(
  ...
  >(
    ...
    [](
      ...
      common::optional<std::shared_ptr<types::IContent> >,
      common::optional<DeserializationError>
    > {
      switch (a_model_type) {
        case types::ModelType::kIecContent:
...
> IecContentFromElement(
  ...
  >(
    ...
    L"IIecContent",
    types::ModelType::kIecContent,
    IecContentFromSequence<types::IIecContent>
  );
}
...
> OtherContentFromElement(
  ...
  >(
    ...
    L"IOtherContent",
    types::ModelType::kOtherContent,
    OtherContentFromSequence<types::IOtherContent>
  );
}
...
> SpecificationFromElement(
  ...
  >(
    ...
    L"ISpecification",
    types::ModelType::kSpecification,
    SpecificationFromSequence<types::ISpecification>
  );
}
...
const std::size_t kPropertyCountOfLangString = 2;
...
const std::size_t kPropertyCountOfLangStringSet = 1;
...
const std::size_t kPropertyCountOfIecContent = 1;
...
const std::size_t kPropertyCountOfOtherContent = 0;
...
const std::size_t kPropertyCountOfSpecification = 1;
...
> LangStringFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfLangString
    >(
      reader,
...
> LangStringSetFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfLangStringSet
    >(
      reader,
...
> IecContentFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfIecContent
    >(
      reader,
...
> OtherContentFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfOtherContent
    >(
      reader,
...
> SpecificationFromSequence(
  ...
  common::optional<DeserializationError> error(
    ReadProperties<
      properties::kPropertyCountOfSpecification
    >(
      reader,
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeLangStringAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeLangStringAsElement(
  const types::ILangString& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeLangStringAsElement(const types::ILangString&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeLangStringPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeLangStringSetAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeLangStringSetAsElement(
  const types::ILangStringSet& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeLangStringSetAsElement(const types::ILangStringSet&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeLangStringSetPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeContentAsElement(
  const types::IContent& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeContentAsElement(const types::IContent&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeContentPtrAsElement(
  const std::shared_ptr<types::IContent>& that,
  xml_common::SelfClosingWriter& writer
);
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeIecContentAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeIecContentAsElement(
  const types::IIecContent& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeIecContentAsElement(const types::IIecContent&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeIecContentPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeOtherContentAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeOtherContentAsElement(
  const types::IOtherContent& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeOtherContentAsElement(const types::IOtherContent&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeOtherContentPtrAsElement(
 ...
 * \return error, if any
 */
common::optional<xml_common::SerializationError> SerializeSpecificationAsSequence(
 ...
 * \return an error, if any
 */
common::optional<xml_common::SerializationError> SerializeSpecificationAsElement(
  const types::ISpecification& that,
  xml_common::SelfClosingWriter& writer
);

/** @copybrief SerializeSpecificationAsElement(const types::ISpecification&, xml_common::SelfClosingWriter& */
common::optional<xml_common::SerializationError> SerializeSpecificationPtrAsElement(
...
common::optional<xml_common::SerializationError> SerializeLangStringPtrAsElement(
  ...
  return SerializeLangStringAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeLangStringSetAsSequence(
  ...
  error = WriteListOfInstancesProperty(
    ...
    that.lang_strings(),
    writer,
    iteration::Property::kLangStrings,
    SerializeLangStringPtrAsElement
  );
  if (error.has_value()) {
    return error;
  }
...
common::optional<xml_common::SerializationError> SerializeLangStringSetAsElement(
  ...
  return WriteElement(
    ...
    that,
    writer,
    SerializeLangStringSetAsSequence
  );
}
...
common::optional<xml_common::SerializationError> SerializeLangStringSetPtrAsElement(
  ...
  return SerializeLangStringSetAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeContentAsElement(
  ...
  switch (that.model_type()) {
    case types::ModelType::kIecContent:
      return SerializeIecContentAsElement(
        dynamic_cast<
          const types::IIecContent&
        >(that),
        writer
      );
    case types::ModelType::kOtherContent:
      return SerializeOtherContentAsElement(
        dynamic_cast<
          const types::IOtherContent&
        >(that),
        writer
      );
    default:
...
common::optional<xml_common::SerializationError> SerializeContentPtrAsElement(
  ...
  return SerializeContentAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeIecContentPtrAsElement(
  ...
  return SerializeIecContentAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeOtherContentAsElement(
  ...
  return WriteElement(
    ...
    that,
    writer,
    SerializeOtherContentAsSequence
  );
}
...
common::optional<xml_common::SerializationError> SerializeOtherContentPtrAsElement(
  ...
  return SerializeOtherContentAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeSpecificationAsSequence(
  ...
  error = WriteProperty(
    ...
    that.content(),
    writer,
    iteration::Property::kContent,
    SerializeContentAsElement
  );
  if (error.has_value()) {
    return error;
  }
...
common::optional<xml_common::SerializationError> SerializeSpecificationAsElement(
  ...
  return WriteElement(
    ...
    that,
    writer,
    SerializeSpecificationAsSequence
  );
}
...
common::optional<xml_common::SerializationError> SerializeSpecificationPtrAsElement(
  ...
  return SerializeSpecificationAsElement(*that, writer);
}
...
common::optional<xml_common::SerializationError> SerializeSomethingAsSequence(
  ...
  error = WriteProperty(
    ...
    writer,
    iteration::Property::kDefaultLanguage,
    WriteWstring
  );
  if (error.has_value()) {
    return error;
  ...
  error = WriteListOfInstancesProperty(
    ...
    writer,
    iteration::Property::kLangStringSets,
    SerializeLangStringSetPtrAsElement
  );
  if (error.has_value()) {
    return error;
  }
  ...
  error = WriteListOfInstancesProperty(
    ...
    that.specifications(),
    writer,
    iteration::Property::kSpecifications,
    SerializeSpecificationPtrAsElement
  );
  if (error.has_value()) {
    return error;
  }
...
common::optional<xml_common::SerializationError> WriteClass(
  ...
  switch (that.model_type()) {
    case types::ModelType::kLangString:
      return SerializeLangStringAsElement(
        dynamic_cast<
          const types::ILangString&
        >(that),
        writer
      );
    case types::ModelType::kLangStringSet:
      return SerializeLangStringSetAsElement(
        dynamic_cast<
          const types::ILangStringSet&
        >(that),
        writer
      );
    case types::ModelType::kIecContent:
    ...
    case types::ModelType::kSpecification:
      return SerializeSpecificationAsElement(
        dynamic_cast<
          const types::ISpecification&
        >(that),
        writer
      );
    case types::ModelType::kSomething:

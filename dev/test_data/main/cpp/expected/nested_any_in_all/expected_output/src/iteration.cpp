...
std::wstring PropertyToWstring(
  ...
  switch (property) {
    case Property::kContent:
      return L"content";
    case Property::kDefaultLanguage:
      return L"default_language";
    case Property::kDefinition:
      return L"definition";
    case Property::kLangStringSets:
      return L"lang_string_sets";
    case Property::kLangStrings:
      return L"lang_strings";
    case Property::kLanguage:
      return L"language";
    case Property::kSpecifications:
...
using listOf_LangString = std::vector<
  std::shared_ptr<types::ILangString>
>;

using listOf_LangStringSet = std::vector<
  std::shared_ptr<types::ILangStringSet>
>;

using listOf_Specification = std::vector<
  std::shared_ptr<types::ISpecification>
>;

std::unique_ptr<impl::IIterator> Over_listOf_LangString(
  const listOf_LangString& value,
  bool recursive
) {
  return Each(value, &OneThenOver<types::ILangString>, recursive);
}

std::unique_ptr<impl::IIterator> Over_listOf_LangStringSet(
  const listOf_LangStringSet& value,
  bool recursive
) {
  return Each(value, &OneThenOver<types::ILangStringSet>, recursive);
}

std::unique_ptr<impl::IIterator> Over_listOf_Specification(
  const listOf_Specification& value,
  bool recursive
) {
  return Each(value, &OneThenOver<types::ISpecification>, recursive);
}

std::unique_ptr<impl::IIterator> Over_LangStringSet(
  const types::ILangStringSet& that,
  bool recursive
) {
  return InProperty(
    Property::kLangStrings,
    Over_listOf_LangString(that.lang_strings(), recursive)
  );
}

std::unique_ptr<impl::IIterator> Over_IecContent(
  ...
  return InProperty(
    ...
    that.definition().has_value()
      ? Over_listOf_LangString((*that.definition()), recursive)
      : Empty()
  );
}

std::unique_ptr<impl::IIterator> Over_Specification(
  const types::ISpecification& that,
  bool recursive
) {
  return InProperty(
    Property::kContent,
    OneThenOver(that.content(), recursive)
  );
}
...
std::unique_ptr<impl::IIterator> Over_Something(
  ...
  return Chain(
    InProperty(
      Property::kLangStringSets,
      Over_listOf_LangStringSet(
        that.lang_string_sets(),
        recursive
      )
    ),
    InProperty(
      Property::kSpecifications,
      that.specifications().has_value()
        ? Over_listOf_Specification(
            (*that.specifications()),
            recursive
          )
        : Empty()
...
std::unique_ptr<impl::IIterator> DispatchOnModelType(
  ...
  switch (instance.model_type()) {
    case types::ModelType::kLangStringSet:
      return Over_LangStringSet(
        dynamic_cast<const types::ILangStringSet&>(instance),
        recursive
      );
    case types::ModelType::kIecContent:
      return Over_IecContent(
        dynamic_cast<const types::IIecContent&>(instance),
        recursive
      );
    case types::ModelType::kSpecification:
      return Over_Specification(
        dynamic_cast<const types::ISpecification&>(instance),
        recursive
      );

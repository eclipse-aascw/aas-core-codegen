...
bool SwitchOnStr(
  ...
  if (text == L"alpha") {
    return true;
  } else if (text == L"beta" || text == L"gamma") {
    return false;
...
bool SwitchOnConstrainedStr(
  ...
  if (text == L"forbidden" || text == L"banned") {
    return false;
  } else {
    return true;
  }
...
bool Something_5(
  ...
  return verification::SwitchOnEnumWithVariablesInCases(
    that->kind(),
    that->text()
  );
}
...
bool Something_6(
  ...
  return verification::SwitchOnEnumWithPass(
    that->kind()
  );
}
...
bool Something_7(
  ...
  return verification::SwitchOnEnumWithLabelsInTuple(
    that->kind()
  );
}
...
bool Something_8(
  ...
  return verification::SwitchOnEnumWithDefault(
    that->kind()
  );
}

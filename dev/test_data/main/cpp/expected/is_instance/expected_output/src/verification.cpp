...
bool HasLeafInTree(
  const std::shared_ptr<types::IElement>& element
) {
  return (
    (
      ...
      || (
        (
          ...
          && common::Some(
            [&](const std::shared_ptr<types::IElement>& child) -> bool {
              return HasLeafInTree(
                child
              );
            },
            std::dynamic_pointer_cast<types::IContainer>(element)->children()
          )
        )
      )
    )
  ...
  return (
    (
      ...
      && (
        ...
        || common::All(
          [&](const std::shared_ptr<types::IElement>& child) -> bool {
            return LeavesInTreeAreNotEmpty(
              child
            );
          },
          std::dynamic_pointer_cast<types::IContainer>(element)->children()
...
bool IsContainer(
  ...
  return (
    (
      types::IsOrderedContainer(*element)
      || types::IsUnorderedContainer(*element)
    )
  );
}

bool IsSortedOrderedContainer(
  const std::shared_ptr<types::IElement>& element
) {
  return (
    (
      types::IsContainer(*element)
      && types::IsOrderedContainer(
        *std::dynamic_pointer_cast<types::IContainer>(element)
      )
      && std::dynamic_pointer_cast<types::IOrderedContainer>(element)->is_sorted()
    )
  );
}

bool ContainerHasChildren(
  const std::shared_ptr<types::IContainer>& container
) {
  return container->children().size() > 0;
}

bool IsGlobalAttributeOfKindName(
  const types::Value& value
) {
  return (
    (
      types::IsAttributeOperand(*types::UnderlyingOfValue(value))
      && types::IsGlobalAttribute(
        *types::UnderlyingOfAttributeItem(
          std::dynamic_pointer_cast<types::IAttributeOperand>(types::UnderlyingOfValue(value))->attribute()
        )
      )
      && std::dynamic_pointer_cast<types::IGlobalAttribute>(
        types::UnderlyingOfAttributeItem(
          std::dynamic_pointer_cast<types::IAttributeOperand>(types::UnderlyingOfValue(value))->attribute()
        )
      )->kind() == L"name"
...
bool IsStringValue(
  ...
  return (
    (
      types::IsStringLiteral(*types::UnderlyingOfValue(value))
      || types::IsAttributeOperand(*types::UnderlyingOfValue(value))
    )
  );
}
...
bool Something_0(
  ...
  return verification::HasLeafInTree(
    that->root()
  );
}
...
bool Something_1(
  ...
  return verification::IsGlobalAttributeOfKindName(
    that->value()
  );
}
...
bool Something_2(
  ...
  return common::All(
    [&](const types::Value& value) -> bool {
      return !types::IsNumberLiteral(*types::UnderlyingOfValue(value))
      || (std::dynamic_pointer_cast<types::INumberLiteral>(types::UnderlyingOfValue(value))->number() >= 0.0);
    },
    that->values()
  );
}
...
bool Something_3(
  ...
  return common::Some(
    [&](const types::Value& value) -> bool {
      return (
        types::IsStringLiteral(*types::UnderlyingOfValue(value))
        && std::dynamic_pointer_cast<types::IStringLiteral>(types::UnderlyingOfValue(value))->text() == L"root"
      );
    },
    that->values()
  );
...
bool Something_4(
  ...
  return !types::IsContainer(*that->root())
  || verification::ContainerHasChildren(
    std::dynamic_pointer_cast<types::IContainer>(that->root())
  );
}
  ...
  switch (shape) {
    case Shape::kSomething: {
      static const std::vector<Check> checks = {
        {
          &Something_0,
          L"There must be at least one leaf in the tree."
        },
        {
          &Something_1,
          L"The value must be a global attribute of kind name."
        },
        {
          &Something_2,
          L"The number literals among the values must be non-negative."
        },
        {
          &Something_3,
          L"There must be at least one string literal ``root`` among "
          L"the values."
        },
        {
          &Something_4,
          L"The root, if a container, must have children."
        },
        {
          &Something_5,
          L"The optional element, if a leaf, must have a non-empty text."
        }
      };
      return checks;
    }

...
> kMapOfSomething = {
  ...
  {
    "someOptionalFloat",
    OfSomething::kSomeOptionalFloat
  },
  {
    "someFloats",
...
> SomethingFromSequence(
  ...
  common::optional<double> the_some_optional_float;
    ...
    >(
      ...
      [&](
        ...
        switch (property) {
          ...
          case properties::OfSomething::kSomeOptionalFloat:
            return ReadInto(
          ...
          case properties::OfSomething::kSomePair:
            return ReadInto(
              the_some_pair,
              DeserializeTuple2<
                std::wstring,
  ...
  if (!the_some_pair.has_value()) {
    return NoInstanceAndDeserializationErrorWithCause<
      std::shared_ptr<T>
    >(
      L"The required property somePair is missing"
    );
  }
  ...
  return std::make_pair(
    ...
    >(
      ...
      new types::Something(
        ...
        std::move(*the_some_pair),
        std::move(the_some_optional_float)
      )
    ),
    common::nullopt
  );
...
common::optional<xml_common::SerializationError> SerializeSomethingAsSequence(
  ...
  error = WriteProperty(
    ...
    writer,
    iteration::Property::kSomeOptionalFloat,
    WriteDouble
  );
  if (error.has_value()) {
    return error;
  ...
  error = WriteTuple2Property(
    ...
    [](
      ...
      return WriteElement("v2", item, a_writer, WriteDouble);
    }
  );
  if (error.has_value()) {
    return error;

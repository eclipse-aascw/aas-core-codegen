...
DeserializationError ConvertXmlRpcDeserializationError(
  ...
  std::wstring path_str = error.path.ToWstring();

  if (path_str.empty()) {
    return DeserializationError(std::move(error.cause));
  }
...
xml_common::SerializationError ConvertXmlRpcSerializationError(
  ...
  if (path_str.empty()) {
    return xml_common::SerializationError(std::move(error.cause));
  }

  return xml_common::SerializationError(
    common::Concat(
      std::move(error.cause),
      L" (at the JSON path ",
      path_str,
...
common::optional<xml_common::SerializationError> SerializeJsonValueToXmlRpc(
  ...
  common::optional<xml_rpc::SerializationError> xml_rpc_error(
    xml_rpc::SerializeValueBodyTo(writer, value)
  );
...
common::optional<xml_common::SerializationError> SerializeJsonArrayToXmlRpc(
  ...
  common::optional<xml_rpc::SerializationError> xml_rpc_error(
    xml_rpc::SerializeArrayBodyTo(writer, value)
  );
...
common::optional<xml_common::SerializationError> SerializeJsonObjectToXmlRpc(
  ...
  common::optional<xml_rpc::SerializationError> xml_rpc_error(
    xml_rpc::SerializeStructBodyTo(writer, value)
  );

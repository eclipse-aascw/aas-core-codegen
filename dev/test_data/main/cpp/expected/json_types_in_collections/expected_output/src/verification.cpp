...
using tupleOf4_str_jsonValue_jsonArray_jsonObjectOf_str = std::tuple<
  std::wstring,
  nlohmann::json,
  nlohmann::json,
  nlohmann::json
...
std::unique_ptr<IIterator> Over_tupleOf4_str_jsonValue_jsonArray_jsonObjectOf_str(
  const tupleOf4_str_jsonValue_jsonArray_jsonObjectOf_str& value,
  bool
) {
  return Chain(
    AtIndex(1, One(&std::get<1>(value), Shape::kJSONValue)),
    AtIndex(2, One(&std::get<2>(value), Shape::kJSONArray)),
    AtIndex(3, One(&std::get<3>(value), Shape::kJSONObject))
  );
}
...
std::unique_ptr<IIterator> Over_Something(
  ...
  return Chain(
    InProperty(
      ...
      Over_listOf_jsonValue(that.values(), recursive)
    ),
    InProperty(
      iteration::Property::kTupleWithJson,
      Over_tupleOf4_str_jsonValue_jsonArray_jsonObjectOf_str(

...
using TupleOf4_str_JsonValue_JsonArray_JsonObject = std::tuple<
  std::wstring,
  nlohmann::json,
  nlohmann::json,
  nlohmann::json
...
std::unique_ptr<IIterator> OverTupleOf4_str_JsonValue_JsonArray_JsonObject(
  const TupleOf4_str_JsonValue_JsonArray_JsonObject& value,
  bool
) {
  return Chain(
...
std::unique_ptr<IIterator> OverSomething(
  ...
  return Chain(
    InProperty(
      ...
      OverListOf_JsonValue(that.values(), recursive)
    ),
    InProperty(
      iteration::Property::kTupleWithJson,
      OverTupleOf4_str_JsonValue_JsonArray_JsonObject(

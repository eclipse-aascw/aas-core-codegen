...
public class Xmlization {
  ...
  private static class _DeserializeImplementation
  {
     ...
     */
    private static Reporting.Result<Item> readItemFromSequence(
      XMLEventReader reader,
      ...
      if (theTexts == null) {
        return missingRequiredProperty("texts", "Item");
      }

      return Reporting.Result.success(new Item(
        theTexts));
    }

    /**
     * Deserialize an instance of class Item from an XML element.
     */
    private static Reporting.Result<? extends Item> readItemFromElement(
      XMLEventReader reader) {
      return XmlCommon.readNamedElement(
        reader,
        "item",
        _DeserializeImplementation::readItemFromSequence);
    }
    ...
    private static Reporting.Result<Something> readSomethingFromSequence(
        ...
        while (!atEndOfSequence(reader)) {
          ...
          switch (elementName) {
            case "kind": {
              ...
              final Reporting.Result<Kind> value =
                readTextAs_Kind(reader, isEmptyProperty);
              if (value.isError()) {
                valueError = value.getError();
              } else {
      ...
      if (theKind == null) {
        return missingRequiredProperty("kind", "Something");
      }

      if (theNumbers == null) {
        return missingRequiredProperty("numbers", "Something");
      }

      if (theTexts == null) {
        return missingRequiredProperty("texts", "Something");
      }
   ...
   * Item anInstance = Deserialize.deserializeItem(
   *   reader);
   * }
   * </pre>
   *

...
public class TestCopying {
  private static class _DeepEqualiser extends AbstractTransformerWithContext<IClass, Boolean> {
    @Override
    public Boolean transformItem(IItem that, IClass other) {
    ...
    public Boolean transformSomething(ISomething that, IClass other) {
      ...
      return (
        ...
        && that.getNumbers().equals(casted.getNumbers())
        && that.getTexts().equals(casted.getTexts())
  ...
  private static Boolean ItemShallowEquals(
    Item that,
    Item other) {
    return that.getTexts().equals(other.getTexts());
  }
  ...
  @Test
  public void testItemShallowCopy() throws IOException {
    final Item instance = CommonJsonization.loadMaximalItem();
    final Item instanceCopy = Copying.shallow(instance);

    assertTrue(
      ItemShallowEquals(instance, instanceCopy),
      "Item");
  } // public void testItemShallowCopy

  @Test
  public void testItemDeepCopy() throws IOException {
    final Item instance = CommonJsonization.loadMaximalItem();
    final Item instanceCopy = Copying.deep(instance);

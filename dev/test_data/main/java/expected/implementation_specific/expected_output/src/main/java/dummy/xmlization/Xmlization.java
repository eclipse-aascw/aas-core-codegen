...
public class Xmlization {
  ...
  private static class _DeserializeImplementation
  {
    ...
    private static Reporting.Result<Color> readTextAs_Color(
      XMLEventReader reader, boolean isEmpty) {
      return readEnum(
        reader,
        isEmpty,
    ...
    private static Reporting.Result<List<IItem>> readListOf_IItem(
      XMLEventReader reader, boolean isEmpty) {
      return readList(
        reader, isEmpty, _DeserializeImplementation::readIItemFromElement);
    }
     ...
     */
    private static Reporting.Result<? extends IItem> readIItemFromElement(
      XMLEventReader reader) {
      // NOTE (mristin):
      ...
      switch (tryElementName.getResult()) {
        case "bag":
          return readBagFromElement(reader);
        case "box":
          return readBoxFromElement(reader);
        default:
          return Reporting.Result.failure(new Reporting.Error(
     ...
     */
    private static Reporting.Result<Box> readBoxFromSequence(
      XMLEventReader reader,
        ...
        while (!atEndOfSequence(reader)) {
          ...
          switch (elementName) {
            ...
            case "color": {
              ...
              final Reporting.Result<Color> value =
                readTextAs_Color(reader, isEmptyProperty);
              if (value.isError()) {
                valueError = value.getError();
              } else {
                theColor = value.getResult();
              }
              break;
            }
            default:
              return unexpectedProperty("Box", elementName);
          }
      ...
      if (theLabel == null) {
        return missingRequiredProperty("label", "Box");
      }
    ...
    /**
     * Deserialize an instance of class Box from an XML element.
     */
    private static Reporting.Result<? extends Box> readBoxFromElement(
      XMLEventReader reader) {
      return readNamedElement(
        reader,
        "box",
        _DeserializeImplementation::readBoxFromSequence);
    }
     ...
     * was a self-closing element.
     */
    private static Reporting.Result<Bag> readBagFromSequence(
      XMLEventReader reader,
      boolean isEmptySequence) {
      String theLabel = null;
          ...
          switch (elementName) {
            ...
            case "tags": {
              ...
              if (value.isError()) {
                ...
                theTags = value.getResult();
              }
              break;
            }
            default:
              return unexpectedProperty("Bag", elementName);
          }
      ...
      if (theLabel == null) {
        return missingRequiredProperty("label", "Bag");
      }

      if (theTags == null) {
        return missingRequiredProperty("tags", "Bag");
      }
    ...
    /**
     * Deserialize an instance of class Bag from an XML element.
     */
    private static Reporting.Result<? extends Bag> readBagFromElement(
      XMLEventReader reader) {
      return readNamedElement(
        reader,
        "bag",
        _DeserializeImplementation::readBagFromSequence);
    }
    ...
    private static Reporting.Result<Container> readContainerFromSequence(
        ...
        while (!atEndOfSequence(reader)) {
          ...
          switch (elementName) {
            ...
            case "items": {
              ...
              final Reporting.Result<List<IItem>> value =
                readListOf_IItem(reader, isEmptyProperty);
              if (value.isError()) {
                valueError = value.getError();
              } else {
      ...
      if (theNames == null) {
        return missingRequiredProperty("names", "Container");
      }

      if (theItems == null) {
        return missingRequiredProperty("items", "Container");
      }
  ...
  {
    /**
     * Deserialize an instance of IItem from {@code reader}.
     *
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static IItem deserializeIItem(
      XMLEventReader reader) {

      _DeserializeImplementation.skipStartDocument(reader);
      _DeserializeImplementation.skipWhitespaceAndComments(reader);

      Reporting.Result<? extends IItem> result =
        _DeserializeImplementation.readIItemFromElement(
          reader);

      return result.onError(error -> {
        error.prependSegment(new Reporting.NameSegment("iitem"));
    ...
    /**
     * Deserialize an instance of Box from {@code reader}.
     *
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Box deserializeBox(
      XMLEventReader reader) {

      _DeserializeImplementation.skipStartDocument(reader);
      _DeserializeImplementation.skipWhitespaceAndComments(reader);

      Reporting.Result<? extends Box> result =
        _DeserializeImplementation.readBoxFromElement(
          reader);

      return result.onError(error -> {
        error.prependSegment(new Reporting.NameSegment("box"));
        throw new DeserializeException(
          Reporting.generateRelativeXPath(error.getPathSegments()),
          error.getCause());
      });
    ...
    /**
     * Deserialize an instance of Bag from {@code reader}.
     *
     * @param reader Initialized XML reader with reader.peek() set to the element
     */
    public static Bag deserializeBag(
      XMLEventReader reader) {

      _DeserializeImplementation.skipStartDocument(reader);
      _DeserializeImplementation.skipWhitespaceAndComments(reader);

      Reporting.Result<? extends Bag> result =
        _DeserializeImplementation.readBagFromElement(
          reader);

      return result.onError(error -> {
        error.prependSegment(new Reporting.NameSegment("bag"));
        throw new DeserializeException(
          Reporting.generateRelativeXPath(error.getPathSegments()),
          error.getCause());
      });
  ...
  static class _VisitorWithWriter
    ...
    private static void writeBoxAsSequence(
      IBox that,
      XMLStreamWriter writer) {
      writeProperty(
        "label",
    ...
    public void visitBox(
      ...
      writeElement(
        ...
        writer,
        withNamespace,
        _VisitorWithWriter::writeBoxAsSequence);
    }

    private static void writeBagAsSequence(
      IBag that,
      XMLStreamWriter writer) {
      writeProperty(
        "label",
    ...
    public void visitBag(
      ...
      writeElement(
        ...
        writer,
        withNamespace,
        _VisitorWithWriter::writeBagAsSequence);
    }

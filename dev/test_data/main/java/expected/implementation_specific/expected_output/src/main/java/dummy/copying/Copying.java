...
public class Copying
{
    ...
    private static class _ShallowCopier extends AbstractTransformer<IClass> {
        ...
        public IClass transformBox(
            ...
            return new Box(that.getLabel(), that.getColor().orElse(null));
        }
        ...
        public IClass transformBag(
            ...
            return new Bag(that.getLabel(), that.getTags());
        }
        ...
        public IClass transformContainer(
            ...
            return new Container(that.getNames(), that.getItems());
        }
    }

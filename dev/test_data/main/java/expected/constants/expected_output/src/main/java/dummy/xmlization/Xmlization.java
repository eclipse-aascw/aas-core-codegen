...
public class Xmlization {
  ...
  private static class _DeserializeImplementation
  {
    ...
    private static Reporting.Result<SomeEnum> readTextAs_SomeEnum(
    ...
    private static Reporting.Result<Something> readSomethingFromSequence(
      ...
      if (!isEmptySequence) {
        while (!atEndOfSequence(reader)) {
          ...
          switch (elementName) {
            case "someEnum": {
              final Reporting.Result<SomeEnum> value =
                readTextAs_SomeEnum(reader, isEmptyProperty);
              if (value.isError()) {
                valueError = value.getError();
              } else {
                theSomeEnum = value.getResult();
              }
              break;
            }
            default:
      ...
      if (theSomeEnum == null) {
        return missingRequiredProperty("someEnum", "Something");
      }

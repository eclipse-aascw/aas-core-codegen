...
public class TestCopying {
  private static class _DeepEqualiser extends AbstractTransformerWithContext<IClass, Boolean> {
    ...
    public Boolean transformSomething(ISomething that, IClass other) {
      ...
      return (
        that.getValue().equals(
          casted.getValue())
        && that.getValues().equals(
          casted.getValues())
        && that.getMapping().equals(
          casted.getMapping())
        && that.getMappingWithConstrainedKey().equals(
          casted.getMappingWithConstrainedKey())
        && (that.getOptionalValue().isPresent()
          ? casted.getOptionalValue().isPresent()
            && that.getOptionalValue().get().equals(
              casted.getOptionalValue().get())
          : ! casted.getOptionalValue().isPresent())
        && (that.getOptionalValues().isPresent()
          ? casted.getOptionalValues().isPresent()
            && that.getOptionalValues().get().equals(
              casted.getOptionalValues().get())
          : ! casted.getOptionalValues().isPresent())
        && (that.getOptionalMapping().isPresent()
          ? casted.getOptionalMapping().isPresent()
            && that.getOptionalMapping().get().equals(
              casted.getOptionalMapping().get())
          : ! casted.getOptionalMapping().isPresent()));
    }
  ...
  private static Boolean SomethingShallowEquals(
    ...
    return (
      ...
      && that.getMappingWithConstrainedKey().equals(other.getMappingWithConstrainedKey())
      && that.getOptionalValue().equals(other.getOptionalValue())
      && that.getOptionalValues().equals(other.getOptionalValues())

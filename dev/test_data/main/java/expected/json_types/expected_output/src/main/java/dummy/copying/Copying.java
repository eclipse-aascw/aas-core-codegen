    ...
    private static class _ShallowCopier extends AbstractTransformer<IClass> {
        ...
        public IClass transformSomething(
            ...
            return new Something(
                ...
                that.getOptionalValue().orElse(null),
                that.getOptionalValues().orElse(null),
    ...
    private static class _DeepCopier extends AbstractTransformer<IClass> {
        ...
        public IClass transformSomething (
            ...
            return new Something(
                ...
                that.getMappingWithConstrainedKey().deepCopy(),
                that.getOptionalValue().isPresent()
                    ? that.getOptionalValue().get().deepCopy()
                    : null,
                that.getOptionalValues().isPresent()
                    ? that.getOptionalValues().get().deepCopy()
                    : null,

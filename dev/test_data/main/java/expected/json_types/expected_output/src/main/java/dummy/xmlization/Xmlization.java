...
public class Xmlization {
  ...
  private static class _DeserializeImplementation
  {
    ...
    private static Reporting.Result<Something> readSomethingFromSequence(
      ...
      JsonNode theValue = null;
      ArrayNode theValues = null;
      ObjectNode theMapping = null;
      ObjectNode theMappingWithConstrainedKey = null;
      JsonNode theOptionalValue = null;
      ArrayNode theOptionalValues = null;
        ...
        while (!atEndOfSequence(reader)) {
          ...
          switch (elementName) {
            case "value": {
              ...
              final Reporting.Result<JsonNode> value =
                readTextAs_jsonValue(reader, isEmptyProperty);
              if (value.isError()) {
            ...
            case "mapping": {
              ...
              final Reporting.Result<ObjectNode> value =
                readTextAs_jsonObject(reader, isEmptyProperty);
              if (value.isError()) {
                valueError = value.getError();
              } else {
            ...
            case "mappingWithConstrainedKey": {
              ...
              if (value.isError()) {
                ...
                theMappingWithConstrainedKey = value.getResult();
              }
              break;
            }
            case "optionalValue": {
              ...
              if (value.isError()) {
                ...
                theOptionalValue = value.getResult();
              }
              break;
            }
            case "optionalValues": {
              ...
              if (value.isError()) {
                ...
                theOptionalValues = value.getResult();
              }
              break;
            }
            case "optionalMapping": {
              ...
              if (value.isError()) {
                ...
                theOptionalMapping = value.getResult();
              }
              break;
            }
            default:
      ...
      if (theMappingWithConstrainedKey == null) {
        return missingRequiredProperty("mappingWithConstrainedKey", "Something");
      }
  ...
  static class _VisitorWithWriter
    ...
    private static void writeSomethingAsSequence(
      ...
      writeProperty(
        ...
        that.getMappingWithConstrainedKey(),
        writer,
        _VisitorWithWriter::writeJsonObjectContent);

      writeOptionalProperty(
        "optionalValue",
        that.getOptionalValue(),
        writer,
        _VisitorWithWriter::writeJsonValueContent);

      writeOptionalProperty(
        "optionalValues",
        that.getOptionalValues(),
        writer,
        _VisitorWithWriter::writeJsonArrayContent);

      writeOptionalProperty(
        "optionalMapping",
        that.getOptionalMapping(),
        writer,
        _VisitorWithWriter::writeJsonObjectContent);
    }

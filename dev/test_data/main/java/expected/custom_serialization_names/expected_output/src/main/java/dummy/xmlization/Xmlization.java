...
public class Xmlization {
  ...
  private static class _DeserializeImplementation
  {
     ...
     */
    private static Reporting.Result<QueryCondition> readQueryConditionFromSequence(
      XMLEventReader reader,
          ...
          switch (elementName) {
            ...
            case "not-eq": {
              ...
              if (value.isError()) {
                ...
                theNotEq = value.getResult();
              }
              break;
            }
            default:
              return unexpectedProperty("QueryCondition", elementName);
          }
     ...
     */
    private static Reporting.Result<? extends QueryCondition> readQueryConditionFromElement(
      XMLEventReader reader) {
      return readNamedElement(
        reader,
        "queryCondition",
        _DeserializeImplementation::readQueryConditionFromSequence);
    }
  }
  ...
  public static class Deserialize
  {
    ...
    public static QueryCondition deserializeQueryCondition(
      ...
      Reporting.Result<? extends QueryCondition> result =
        _DeserializeImplementation.readQueryConditionFromElement(
          reader);
  ...
  static class _VisitorWithWriter
    ...
    private static void writeQueryConditionAsSequence(
    ...
    public void visitQueryCondition(
      ...
      writeElement(
        ...
        writer,
        withNamespace,
        _VisitorWithWriter::writeQueryConditionAsSequence);
    }
  }

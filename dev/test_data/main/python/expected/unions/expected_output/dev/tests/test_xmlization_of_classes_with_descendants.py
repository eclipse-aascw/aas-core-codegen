...
class TestRoundTrips(unittest.TestCase):
    def test_mixed_abstract_member(self) -> None:
        for xml_class_name_of_descendant in [
            ...
            for path in sorted(
                ...
                got_from_iterparse = aas_xmlization.mixed_abstract_member_from_iterparse(iterator)
                ...
                # region From stream
                got_from_stream = aas_xmlization.mixed_abstract_member_from_stream(io.StringIO(text))
                ...
                with tempfile.TemporaryDirectory() as tmp_dir:
                    ...
                    got_from_file = aas_xmlization.mixed_abstract_member_from_file(path)
                ...
                # region From string
                got_from_str = aas_xmlization.mixed_abstract_member_from_str(text)
    ...
    def test_mixed_concrete_with_descendants(self) -> None:
        for xml_class_name_of_descendant in [
            ...
            for path in sorted(
                ...
                # region From iterparse
                iterator = ET.iterparse(source=io.StringIO(text), events=["start", "end"])
                got_from_iterparse = aas_xmlization.mixed_concrete_with_descendants_from_iterparse(iterator)
                ...
                # region From stream
                got_from_stream = aas_xmlization.mixed_concrete_with_descendants_from_stream(io.StringIO(text))
                et_from_stream = ET.fromstring(aas_xmlization.to_str(got_from_stream))
                tests.common_xmlization.remove_redundant_whitespace(et_from_stream)
                tests.common_xmlization.assert_elements_equal(et_concrete, et_from_stream)
                # endregion
                ...
                with tempfile.TemporaryDirectory() as tmp_dir:
                    ...
                    got_from_file = aas_xmlization.mixed_concrete_with_descendants_from_file(path)
                et_from_file = ET.fromstring(aas_xmlization.to_str(got_from_file))
                tests.common_xmlization.remove_redundant_whitespace(et_from_file)
                tests.common_xmlization.assert_elements_equal(et_concrete, et_from_file)
                # endregion
                ...
                # region From string
                got_from_str = aas_xmlization.mixed_concrete_with_descendants_from_str(text)
                et_from_str = ET.fromstring(aas_xmlization.to_str(got_from_str))
                tests.common_xmlization.remove_redundant_whitespace(et_from_str)
                tests.common_xmlization.assert_elements_equal(et_concrete, et_from_str)
                # endregion

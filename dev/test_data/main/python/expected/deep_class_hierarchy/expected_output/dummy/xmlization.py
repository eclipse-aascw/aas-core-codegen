...
def _read_branch_as_sequence(
    ...
    the_description: Optional[str] = values.get('description')
...
def _read_branch_as_element(
    ...
    return _read_dispatched(
        element,
        iterator,
        _DISPATCH_FOR_BRANCH,
        "a concrete instance of 'Branch'"
    )
...
def _read_leaf_as_sequence(
    ...
    the_identifier: Optional[str] = values.get('identifier')
    the_description: Optional[str] = values.get('description')
    the_value: Optional[int] = values.get('value')
...
def _read_blossom_as_sequence(
    ...
    values = _read_properties(
        element,
        iterator,
        _READERS_FOR_BLOSSOM
    )

    the_identifier: Optional[str] = values.get('identifier')
    the_description: Optional[str] = values.get('description')
    the_value: Optional[int] = values.get('value')
    the_details: Optional[str] = values.get('details')
...
#: :py:class:`.types.Branch`, by the XML name of the property
_READERS_FOR_BRANCH: Mapping[
    str,
    _ContentReader[Any]
] = {
    'identifier': _read_str_from_element_text,
    'description': _read_str_from_element_text,
}
...
#: Read the content of a property of
#: :py:class:`.types.Blossom`, by the XML name of the property
_READERS_FOR_BLOSSOM: Mapping[
    str,
    _ContentReader[Any]
] = {
    'identifier': _read_str_from_element_text,
    'description': _read_str_from_element_text,
    'value': _read_int_from_element_text,
    'details': _read_str_from_element_text,
}
...
_READERS_FOR_SOMETHING: Mapping[
    ...
    'someChoice': _read_nested__node,
    'somethingWithoutChoice': _read_nested__branch,
}
...
def _write_branch_as_element(
    ...
    """
    serializer._write_start_element(name)
    _write_str_as_element('identifier', that.identifier, serializer)
    _write_str_as_element('description', that.description, serializer)
    serializer._write_end_element(name)
...
def _write_leaf_as_element(
    ...
    _write_str_as_element('identifier', that.identifier, serializer)
    _write_str_as_element('description', that.description, serializer)
    _write_int_as_element('value', that.value, serializer)
    serializer._write_end_element(name)
...
def _write_blossom_as_element(
    ...
    _write_str_as_element('description', that.description, serializer)
    _write_int_as_element('value', that.value, serializer)
    _write_str_as_element('details', that.details, serializer)
    serializer._write_end_element(name)
...
def _write_something_as_element(
    ...
    """
    serializer._write_start_element(name)
    _write_nested_element('someChoice', that.some_choice, serializer)
    _write_nested_element(
        'somethingWithoutChoice', that.something_without_choice, serializer
    )
    serializer._write_end_element(name)
...
def _write_container_as_element(
    ...
    """
    serializer._write_start_element(name)
    _write_nested_element('node', that.node, serializer)
    _write_something_as_element('something', that.something, serializer)
    serializer._write_end_element(name)
...
class _Serializer(aas_types.AbstractVisitor):
    ...
    def visit_branch(
        ...
        :param that: instance to be serialized
        """
        _write_branch_as_element('branch', that, self)
    ...
    def visit_leaf(
        ...
        :param that: instance to be serialized
        """
        _write_leaf_as_element('leaf', that, self)
    ...
    def visit_blossom(
        ...
        :param that: instance to be serialized
        """
        _write_blossom_as_element('blossom', that, self)
    ...
    def visit_container(
        ...
        :param that: instance to be serialized
        """
        _write_container_as_element('container', that, self)

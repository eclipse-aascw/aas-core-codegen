...
class Item(Class):
    ...
    def describe(self) -> str:
        ...
        return f"Item with the label {self.label}"
...
class Box(Item):
    ...
    def relabel(self, new_label: str) -> None:
        """Set the :py:attr:`label` to :paramref:`new_label`."""
    ...
    def accept_with_context(
        ...
        visitor.visit_box_with_context(self, context)
    ...
    def transform(
        ...
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_box(self)
    ...
    def transform_with_context(
        ...
        """
        return transformer.transform_box_with_context(
            self, context)
...
class Bag(Item):
    ...
    def accept_with_context(
        ...
        """Dispatch the :paramref:`visitor` on this instance in :paramref:`context`."""
        visitor.visit_bag_with_context(self, context)
    ...
    def transform(
        ...
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_bag(self)
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_bag_with_context(
            self, context)
...
class AbstractTransformerWithContext(
    ...
    @abc.abstractmethod
    def transform_box_with_context(
            self,
            that: Box,
            context: ContextT
    ) -> T:
    ...
    @abc.abstractmethod
    def transform_bag_with_context(
            self,
            that: Bag,
            context: ContextT
    ) -> T:

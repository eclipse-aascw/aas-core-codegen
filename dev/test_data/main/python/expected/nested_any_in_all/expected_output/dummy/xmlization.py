...
.. code-block::
    ...
    path = pathlib.Path(...)
    instance = aas_xmlization.read_lang_string_from_file(
        path
    )
...
def lang_string_set_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LangStringSet:
    """
    Read an instance of :py:class:`.types.LangStringSet` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.lang_string_set_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.LangStringSet` read from
        :paramref:`iterator`
    """
    return _read_instance_from_iterparse(
        iterator,
        _read_lang_string_set_as_element,
        'LangStringSet'
    )


def lang_string_set_from_stream(
    stream: TextIO,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.LangStringSet:
    """
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.lang_string_set_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.LangStringSet` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    return lang_string_set_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )


def lang_string_set_from_file(
    path: PathLike,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.LangStringSet:
    """
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.lang_string_set_from_file(
            path
        )
...
def lang_string_set_from_str(
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.lang_string_set_from_str(
            text
        )
...
def content_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.Content:
    """
    Read an instance of :py:class:`.types.Content` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.content_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.Content` read from
        :paramref:`iterator`
    """
    return _read_instance_from_iterparse(
        iterator,
        _read_content_as_element,
        'Content'
    )
...
def content_from_stream(
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.content_from_stream(
                stream
            )
...
def content_from_file(
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.content_from_file(
            path
        )
...
def content_from_str(
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.content_from_str(
            text
        )
...
def iec_content_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.IecContent:
    """
    Read an instance of :py:class:`.types.IecContent` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.iec_content_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.IecContent` read from
        :paramref:`iterator`
    """
    return _read_instance_from_iterparse(
        iterator,
        _read_iec_content_as_element,
        'IecContent'
    )


def iec_content_from_stream(
    stream: TextIO,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.IecContent:
    """
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.iec_content_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.IecContent` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    return iec_content_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )


def iec_content_from_file(
    path: PathLike,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.IecContent:
    """
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.iec_content_from_file(
            path
        )
...
def iec_content_from_str(
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.iec_content_from_str(
            text
        )
...
def other_content_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.OtherContent:
    """
    Read an instance of :py:class:`.types.OtherContent` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.other_content_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.OtherContent` read from
        :paramref:`iterator`
    """
    return _read_instance_from_iterparse(
        iterator,
        _read_other_content_as_element,
        'OtherContent'
    )


def other_content_from_stream(
    stream: TextIO,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.OtherContent:
    """
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.other_content_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.OtherContent` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    return other_content_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )


def other_content_from_file(
    path: PathLike,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.OtherContent:
    """
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.other_content_from_file(
            path
        )
...
def other_content_from_str(
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.other_content_from_str(
            text
        )
...
def specification_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.Specification:
    """
    Read an instance of :py:class:`.types.Specification` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.specification_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.Specification` read from
        :paramref:`iterator`
    """
    return _read_instance_from_iterparse(
        iterator,
        _read_specification_as_element,
        'Specification'
    )


def specification_from_stream(
    stream: TextIO,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.Specification:
    """
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.specification_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.Specification` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    return specification_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )


def specification_from_file(
    path: PathLike,
    has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.Specification:
    """
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.specification_from_file(
            path
        )
...
def specification_from_str(
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.specification_from_str(
            text
        )
...
def _read_list_of__lang_string(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
...
def _read_list_of__lang_string_set(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
...
def _read_list_of__specification(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
...
def _read_nested__content(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.Content:
    """
    Read an instance of :py:class:`.types.Content` nested in
...
def _read_lang_string_as_element(
    ...
    return _read_named_element(
        ...
        iterator,
        'langString',
        _read_lang_string_as_sequence
    )


def _read_lang_string_set_as_sequence(
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LangStringSet:
    """
    Read an instance of :py:class:`.types.LangStringSet`
    as a sequence of XML-encoded properties.
    ...
    values = _read_properties(
        element,
        iterator,
        _READERS_FOR_LANG_STRING_SET
    )

    the_lang_strings: Optional[List[aas_types.LangString]] = values.get('langStrings')
...
def _read_lang_string_set_as_element(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.LangStringSet:
    """
    ...
    return _read_named_element(
        ...
        iterator,
        'langStringSet',
        _read_lang_string_set_as_sequence
    )


def _read_content_as_element(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.Content:
    """
    ...
    return _read_dispatched(
        element,
        iterator,
        _DISPATCH_FOR_CONTENT,
        "a concrete instance of 'Content'"
    )


def _read_iec_content_as_sequence(
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
) -> aas_types.IecContent:
    """
    Read an instance of :py:class:`.types.IecContent`
    as a sequence of XML-encoded properties.
    ...
    values = _read_properties(
        element,
        iterator,
        _READERS_FOR_IEC_CONTENT
    )

    the_definition: Optional[List[aas_types.LangString]] = values.get('definition')
...
def _read_iec_content_as_element(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.IecContent:
    """
    ...
    return _read_named_element(
        ...
        iterator,
        'iecContent',
        _read_iec_content_as_sequence
    )


def _read_other_content_as_sequence(
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
) -> aas_types.OtherContent:
    """
    Read an instance of :py:class:`.types.OtherContent`
    as a sequence of XML-encoded properties.
    ...
    _read_properties(
        element,
        iterator,
        _READERS_FOR_OTHER_CONTENT
    )

    return aas_types.OtherContent()


def _read_other_content_as_element(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.OtherContent:
    """
    ...
    return _read_named_element(
        ...
        iterator,
        'otherContent',
        _read_other_content_as_sequence
    )


def _read_specification_as_sequence(
        element: Element,
        iterator: Iterator[Tuple[str, Element]]
) -> aas_types.Specification:
    """
    Read an instance of :py:class:`.types.Specification`
    as a sequence of XML-encoded properties.
    ...
    values = _read_properties(
        element,
        iterator,
        _READERS_FOR_SPECIFICATION
    )

    the_content: Optional[aas_types.Content] = values.get('content')
...
def _read_specification_as_element(
    element: Element,
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.Specification:
    """
    ...
    return _read_named_element(
        ...
        iterator,
        'specification',
        _read_specification_as_sequence
    )
...
def _read_something_as_sequence(
    ...
    the_default_language: Optional[str] = values.get('defaultLanguage')
    the_lang_string_sets: Optional[List[aas_types.LangStringSet]] = values.get(
        'langStringSets'
    )
    the_specifications: Optional[List[aas_types.Specification]] = values.get(
        'specifications'
    )
...
#: corresponding to concrete descendants of Content
_DISPATCH_FOR_CONTENT: Mapping[
    str,
    Callable[
        [
            Element,
    ...
    'iecContent': _read_iec_content_as_sequence,
    'otherContent': _read_other_content_as_sequence,
}
...
_GENERAL_DISPATCH: Mapping[
    ...
    'langString': _read_lang_string_as_sequence,
    'langStringSet': _read_lang_string_set_as_sequence,
    'iecContent': _read_iec_content_as_sequence,
    'otherContent': _read_other_content_as_sequence,
    'specification': _read_specification_as_sequence,
    'something': _read_something_as_sequence,
}


#: Read the content of a property of
#: :py:class:`.types.LangString`, by the XML name of the property
_READERS_FOR_LANG_STRING: Mapping[
    str,
    _ContentReader[Any]
] = {
...
#: Read the content of a property of
#: :py:class:`.types.LangStringSet`, by the XML name of the property
_READERS_FOR_LANG_STRING_SET: Mapping[
    str,
    _ContentReader[Any]
] = {
    'langStrings': _read_list_of__lang_string,
}


#: Read the content of a property of
#: :py:class:`.types.IecContent`, by the XML name of the property
_READERS_FOR_IEC_CONTENT: Mapping[
    str,
    _ContentReader[Any]
] = {
    'definition': _read_list_of__lang_string,
}


#: Read the content of a property of
#: :py:class:`.types.OtherContent`, by the XML name of the property
_READERS_FOR_OTHER_CONTENT: Mapping[
    str,
    _ContentReader[Any]
] = {
}
...
#: Read the content of a property of
#: :py:class:`.types.Specification`, by the XML name of the property
_READERS_FOR_SPECIFICATION: Mapping[
    str,
    _ContentReader[Any]
] = {
    'content': _read_nested__content,
}
...
_READERS_FOR_SOMETHING: Mapping[
    ...
    'defaultLanguage': read_str_from_element_text,
    'langStringSets': _read_list_of__lang_string_set,
    'specifications': _read_list_of__specification,
}
...
def _write_lang_string_as_element(
    name: str,
    prop_name: Optional[str],
...
def _write_lang_string_set_as_element(
    name: str,
    prop_name: Optional[str],
    ...
    try:
        ...
        _write_list_of_instances(
            'langStrings', 'lang_strings', that.lang_strings, serializer
        )
        serializer.writer.write_end_element(name)
    except Exception as exception:
        _attribute_to_property(exception, prop_name)
...
def _write_iec_content_as_element(
    name: str,
    prop_name: Optional[str],
...
def _write_other_content_as_element(
    name: str,
    prop_name: Optional[str],
...
def _write_specification_as_element(
    name: str,
    prop_name: Optional[str],
    ...
    try:
        serializer.writer.write_start_element(name)
        _write_nested_element('content', 'content', that.content, serializer)
        serializer.writer.write_end_element(name)
    except Exception as exception:
        _attribute_to_property(exception, prop_name)
...
def _write_something_as_element(
    ...
    try:
        ...
        _write_str_as_element(
            'defaultLanguage', 'default_language', that.default_language, serializer
        )
        _write_list_of_instances(
            'langStringSets', 'lang_string_sets', that.lang_string_sets, serializer
        )
        if that.specifications is not None:
            _write_list_of_instances(
                'specifications', 'specifications', that.specifications, serializer
            )
        serializer.writer.write_end_element(name)
    except Exception as exception:
        _attribute_to_property(exception, prop_name)
...
class _Serializer(aas_types.AbstractVisitor):
    ...
    def visit_lang_string(
        ...
        :param that: instance to be serialized
        """
        _write_lang_string_as_element('langString', None, that, self)
    ...
    def visit_lang_string_set(
        ...
        :param that: instance to be serialized
        """
        _write_lang_string_set_as_element('langStringSet', None, that, self)
    ...
    def visit_iec_content(
        ...
        :param that: instance to be serialized
        """
        _write_iec_content_as_element('iecContent', None, that, self)
    ...
    def visit_other_content(
        ...
        :param that: instance to be serialized
        """
        _write_other_content_as_element('otherContent', None, that, self)
    ...
    def visit_specification(
        ...
        :param that: instance to be serialized
        """
        _write_specification_as_element('specification', None, that, self)

...
class TestIecContent(unittest.TestCase):
...
class TestSomething(unittest.TestCase):
    def test_over_specifications_or_empty_against_recorded(self) -> None:
        for minimal_or_maximal in ["minimal", "maximal"]:
            instance = tests.common_xmlization.must_load(
                pathlib.Path(
                    tests.common.TEST_DATA_DIR
            ...
            log = [
                tests.common.trace(
                    list(instance.over_specifications_or_empty())
                )
            ]
            ...
            expected_path = pathlib.Path(
                ...
                / 'something'
                / f"on_{minimal_or_maximal}.xml"
                / 'over_specifications_or_empty.trace'
            )

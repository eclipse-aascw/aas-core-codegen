...
class TestVerificationOfInvalidInstances(unittest.TestCase):
    def test_lang_string(self) -> None:
        for cause_dir in sorted(
            ...
            for path in sorted(
                (cause_dir / 'LangString').glob("**/*.json")
            ):
    ...
    def test_lang_string_set(self) -> None:
        for cause_dir in sorted(
            ...
            for path in sorted(
                (cause_dir / 'LangStringSet').glob("**/*.json")
            ):
                rel_path = path.relative_to(tests.common.TEST_DATA_DIR)
    ...
    def test_iec_content(self) -> None:
        for cause_dir in sorted(
            ...
            for path in sorted(
                (cause_dir / 'IecContent').glob("**/*.json")
            ):
                rel_path = path.relative_to(tests.common.TEST_DATA_DIR)
    ...
    def test_other_content(self) -> None:
        for cause_dir in sorted(
            ...
            for path in sorted(
                (cause_dir / 'OtherContent').glob("**/*.json")
            ):
                rel_path = path.relative_to(tests.common.TEST_DATA_DIR)
    ...
    def test_specification(self) -> None:
        for cause_dir in sorted(
            ...
            for path in sorted(
                (cause_dir / 'Specification').glob("**/*.json")
            ):
                rel_path = path.relative_to(tests.common.TEST_DATA_DIR)

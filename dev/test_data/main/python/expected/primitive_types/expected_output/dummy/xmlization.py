...
def _write_something_as_element(
    ...
    """
    serializer._write_start_element(name)
    _write_bool_as_element('someBool', that.some_bool, serializer)
    _write_int_as_element('someInt', that.some_int, serializer)
    _write_float_as_element('someFloat', that.some_float, serializer)
    _write_str_as_element('someString', that.some_string, serializer)
    _write_bytes_as_element('someBytes', that.some_bytes, serializer)
    serializer._write_end_element(name)

...
def _read_something_as_sequence(
    ...
    the_interface: Optional[str] = values.get('interface')
    the_type: Optional[str] = values.get('type')
    the_range: Optional[str] = values.get('range')
    the_void: Optional[str] = values.get('void')
...
def _write_something_as_element(
    ...
    """
    serializer._write_start_element(name)
    _write_str_as_element('interface', that.interface, serializer)
    _write_str_as_element('type', that.type, serializer)
    _write_str_as_element('range', that.range, serializer)
    _write_str_as_element('void', that.void, serializer)
    serializer._write_end_element(name)

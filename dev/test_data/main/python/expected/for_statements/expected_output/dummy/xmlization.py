...
#: :py:class:`.types.Item`, by the XML name of the property
_READERS_FOR_ITEM: Mapping[
    str,
    _ContentReader[Any]
] = {
...
_READERS_FOR_SOMETHING: Mapping[
    ...
    'kind': _read_kind_from_element_text,
    'numbers': _read_list_of__int,
    'texts': _read_list_of__str,
...
def _write_something_as_element(
    ...
    try:
        ...
        _write_list_of_items(
            'numbers', 'numbers', that.numbers, _write_int_as_element, serializer
        )
        _write_list_of_items(
            'texts', 'texts', that.texts, _write_str_as_element, serializer
        )

...
def item_from_jsonable(
    ...
    :return: Parsed instance of :py:class:`.types.Item`
    :raise: :py:class:`DeserializationException` if unexpected :paramref:`jsonable`
    """
    ...
    try:
        for key, jsonable_value in mapping.items():
            if key == 'modelType':
                ...
                the_kind = kind_from_jsonable(jsonable_value)
            elif key == 'numbers':
                the_numbers = _list_of__int_from_jsonable(jsonable_value)
            elif key == 'texts':
                the_texts = _list_of__str_from_jsonable(jsonable_value)
            elif key == 'items':
...
def _something_to_jsonable(
    ...
    try:
        ...
        raise
    try:
        jsonable['numbers'] = _list_of__int_to_jsonable(
            that.numbers
        )
    except SerializationException as exception:

...
def _something_to_jsonable(
    ...
    try:
        ...
        exception._prepend_property('mapping_with_constrained_key')
        raise
    if that.optional_value is not None:
        try:
            ...
            exception._prepend_property('optional_value')
            raise
    if that.optional_values is not None:
        try:
            ...
            exception._prepend_property('optional_values')
            raise
    if that.optional_mapping is not None:
        try:
            ...
            exception._prepend_property('optional_mapping')
            raise
    return jsonable

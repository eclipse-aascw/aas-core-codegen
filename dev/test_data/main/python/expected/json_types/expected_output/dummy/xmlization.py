...
_READERS_FOR_SOMETHING: Mapping[
    ...
    'value': _read_xml_rpc_value_content,
    'values': _read_xml_rpc_array_body,
    'mapping': _read_xml_rpc_struct_body,
    'mappingWithConstrainedKey': _read_xml_rpc_struct_body,
    'optionalValue': _read_xml_rpc_value_content,
    'optionalValues': _read_xml_rpc_array_body,
    'optionalMapping': _read_xml_rpc_struct_body,
}
...
def _write_something_as_element(
    ...
    try:
        serializer._write_start_element(name)
        _write_json_value_as_element('value', 'value', that.value, serializer)
        ...
        if that.optional_value is not None:
            _write_json_value_as_element(
                'optionalValue', 'optional_value', that.optional_value, serializer
            )
        if that.optional_values is not None:
            _write_json_array_as_element(
                'optionalValues', 'optional_values', that.optional_values, serializer
            )

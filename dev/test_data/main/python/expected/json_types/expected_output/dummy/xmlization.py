...
_READERS_FOR_SOMETHING: Mapping[
    ...
    'value': _read_json_value_content,
    'values': _read_json_array_body,
    'mapping': _read_json_object_body,
    'mappingWithConstrainedKey': _read_json_object_body,
    'optionalValue': _read_json_value_content,
    'optionalValues': _read_json_array_body,
